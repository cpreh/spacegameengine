...
if [[ $1 == 'run' ]]; then
	shift
	prettify_includes.py --reserved-prefix sge --reserved-prefix alda --reserved-prefix majutsu --reserved-prefix awl --reserved-prefix mizuiro --reserved-prefix fcppt  "$@" 2>>/tmp/prettify_errors
else
