...
try
{
  ...
  sge::cg::string const pixel_shader_source("struct C3E3f_Output {\n"
                                            "	float4 color : COLOR;\n"
                                            "};\n"
                                            "C3E3f_Output\n"
                                            "C3E3f_simple()\n"
  ...
  sge::cg::program::object pixel_program(sge::cg::program::from_string_parameters(
      ...
      sge::cg::program::main_function("C3E3f_simple"),
  ...
  auto const draw(
      [&loaded_pixel_program, &loaded_vertex_program, &sys, &vertex_buffer, &vertex_declaration]
      {
