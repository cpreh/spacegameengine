...
try
{
  sge::rucksack::testbed::object testbed(
      sge::window::title(FCPPT_TEXT("rucksack enumeration test")));
  ...
  sge::rucksack::widget::enumeration enumeration_box(sge::rucksack::padding(
      5 // NOLINT(cppcoreguidelines-avoid-magic-numbers,readability-magic-numbers)
      ));

  viewport_box.child(
      fcppt::reference_to_base<sge::rucksack::widget::base>(fcppt::make_ref(enumeration_box)));
  ...
  using dummy_sprite_sequence = fcppt::array::object<
      dummy_unique_ptr,
      20 // NOLINT(cppcoreguidelines-avoid-magic-numbers,readability-magic-numbers)
      >;

  auto sprites(fcppt::array::init<dummy_sprite_sequence>(
