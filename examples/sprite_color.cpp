...
try
{
  sge::systems::instance<
      ...
      sys(sge::systems::make_list(
          sge::systems::window(sge::systems::window_source(sge::systems::original_window(
              sge::window::title(FCPPT_TEXT("sge sprite color example"))))))(
  ...
  using sprite_buffers_type =
      sge::sprite::buffers::with_declaration<sge::sprite::buffers::multi<sprite_choices>>;
  ...
  sprite_object const spr(
      ...
      sge::sprite::roles::size{} = fcppt::math::dim::fill<sprite_object::dim>(128),
      sge::sprite::roles::color{} =
          sge::image::color::convert<color_format>(sge::image::color::predef::red()));
