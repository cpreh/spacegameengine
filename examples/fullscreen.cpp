...
try
{
  sge::systems::instance<
      ...
      sys(sge::systems::make_list(sge::systems::window(sge::systems::window_source(
          sge::systems::original_window(sge::window::title(FCPPT_TEXT("sge fullscreen test"))))))(
          sge::systems::renderer(
              ...
              sge::renderer::display_mode::parameters(
                  ...
                  sge::renderer::display_mode::optional_object(sge::renderer::display_mode::object(
  ...
  awl::timer::unique_ptr const timer{sys.window_system().awl_system().processor().create_timer(
      awl::timer::setting_no_period(awl::timer::delay{
          std::chrono::duration_cast<awl::timer::duration>(std::chrono::seconds{3})}))};

  return sge::window::loop(
      sys.window_system(),
      sge::window::loop_function{[&sys, &timer](awl::event::base const &_event)
                                 {
