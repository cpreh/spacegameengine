...
try
{
  sge::systems::instance<
      ...
      sys(sge::systems::make_list(sge::systems::window(sge::systems::window_source(
          sge::systems::original_window(sge::window::title(FCPPT_TEXT("sge custom cursor example")))
              .hide_cursor())))(
          ...
          sge::systems::config().log_settings(sge::systems::log_settings(sge::log::option_container{
              sge::log::option{sge::input::log_location(), fcppt::log::level::debug}}))));

  sge::renderer::texture::planar_unique_ptr const texture(
      sge::renderer::texture::create_planar_from_path(
          sge::config::media_path() / FCPPT_TEXT("images") / FCPPT_TEXT("cursor.png"),
  ...
  sge::texture::part_unique_ptr const texture_part(fcppt::unique_ptr_to_base<sge::texture::part>(
      fcppt::make_unique_ptr<sge::texture::part_raw_ref>(*texture)));

  sge::cursor::object custom_cursor{
      fcppt::make_cref(sys.input_processor()),
      fcppt::make_ref(sys.renderer_device_ffp()),
      fcppt::make_cref(*texture_part),
      sge::cursor::hotspot(sge::cursor::hotspot::value_type(
  ...
  auto const draw(
      [&custom_cursor, &sys]
      {
        ...
        custom_cursor.draw(scoped_block.get());
      });
