...
try
{
  ...
  sge::systems::instance<
      ...
      sys(sge::systems::make_list(sge::systems::window(sge::systems::window_source(
          sge::systems::original_window(sge::window::title(FCPPT_TEXT("sge stencil example"))))))(
          sge::systems::renderer(
              ...
              sge::viewport::optional_resize_callback{
                  sge::viewport::center_on_resize(sge::window::dim{
  ...
  sge::renderer::texture::planar_unique_ptr const texture_grass(
  ...
  sge::renderer::texture::planar_unique_ptr const texture_cloudsquare(
      sge::renderer::texture::create_planar_from_path(
  ...
  sprite_object const small_sprite(
      sge::sprite::roles::pos{} = sprite_object::vector(200, 200),
      ...
      sprite_object::texture_type{
          fcppt::make_shared_ptr<sge::texture::part_raw_ref>(*texture_grass)});
  ...
  sprite_object const big_sprite(
      ...
      sge::sprite::roles::texture0{} = sprite_object::texture_type{
          fcppt::make_shared_ptr<sge::texture::part_raw_ref>(*texture_cloudsquare)});
          ...
          sge::renderer::state::core::depth_stencil::parameters(
              ...
              sge::renderer::state::core::depth_stencil::stencil::variant(
                  sge::renderer::state::core::depth_stencil::stencil::combined_simple(
                      ...
                      .pass_op(sge::renderer::state::core::depth_stencil::stencil::op::inc_sat)
                      .to_enabled()))));
  ...
  auto const draw(
      [&big_sprite, &compare_state, &inc_state, &small_sprite, &sprite_buffers, &sprite_state, &sys]
      {
...

        {
          ...
          sge::renderer::state::core::depth_stencil::scoped const scoped_state(
              ...
              fcppt::make_cref(*inc_state));

          // Render small sprite.
          sge::sprite::process::one(scoped_block.get(), small_sprite, sprite_buffers, sprite_state);
        }

        {
          ...
          sge::renderer::state::core::depth_stencil::scoped const scoped_state(
              fcppt::reference_to_base<sge::renderer::context::core>(
                  fcppt::make_ref(scoped_block.get())),
              fcppt::make_cref(*compare_state));

          // Render big sprite.
          sge::sprite::process::one(scoped_block.get(), big_sprite, sprite_buffers, sprite_state);
        }
      });
