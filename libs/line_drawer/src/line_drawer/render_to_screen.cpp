    ...
    sge::line_drawer::object &_drawer)
{
  sge::renderer::state::ffp::transform::object_unique_ptr const projection(
      _render_device.create_transform_state(sge::renderer::state::ffp::transform::parameters(
          FCPPT_ASSERT_OPTIONAL_ERROR(sge::renderer::projection::orthogonal_viewport(
