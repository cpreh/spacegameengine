...
using format_map = sge::image::impl::format_map<
    SGE_IMAGE_DS_IMPL_MAKE_FORMAT_PAIR(d16),
    SGE_IMAGE_DS_IMPL_MAKE_FORMAT_PAIR(d24s8),
    SGE_IMAGE_DS_IMPL_MAKE_FORMAT_PAIR(d32)>;
