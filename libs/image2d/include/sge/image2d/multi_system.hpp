...
class multi_system : public sge::image2d::system
{
  FCPPT_NONMOVABLE(multi_system);

public:
  SGE_IMAGE2D_DETAIL_SYMBOL
  explicit multi_system(sge::image2d::multi_system_parameters const &);

  SGE_IMAGE2D_DETAIL_SYMBOL
  ~multi_system() override;

  [[nodiscard]] SGE_IMAGE2D_DETAIL_SYMBOL sge::image2d::load_stream_result load_stream(
      sge::media::stream_unique_ptr &&,
      sge::media::optional_extension const &,
      sge::media::optional_name const &) override;

  [[nodiscard]] SGE_IMAGE2D_DETAIL_SYMBOL sge::image2d::optional_file_unique_ptr
  create(sge::image2d::view::const_object const &, sge::media::extension const &) override;

  [[nodiscard]] SGE_IMAGE2D_DETAIL_SYMBOL sge::media::extension_set extensions() const override;

private:
  using muxer = sge::media::muxer<sge::image2d::system, sge::image2d::file>;
