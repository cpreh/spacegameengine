...
sge::image2d::load(sge::image2d::system_ref const _system, std::filesystem::path const &_path)
{
  return sge::media::impl::load<sge::image2d::file_unique_ptr, sge::image2d::exception>(
      _system, _path);
}
