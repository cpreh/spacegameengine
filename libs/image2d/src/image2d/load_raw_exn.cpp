...
sge::image2d::file_unique_ptr sge::image2d::load_raw_exn(
    sge::image2d::system_ref const _system,
    sge::media::const_raw_range const &_range,
    sge::media::optional_extension const &_extension)
{
  return sge::media::impl::load_raw_exn<sge::image2d::file_unique_ptr, sge::image2d::exception>(
      _system, _range, _extension);
}
