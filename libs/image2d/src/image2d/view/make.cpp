...
sge::image2d::view::object sge::image2d::view::make(
    sge::image::raw_pointer const _data,
    sge::image2d::dim const &_dim,
    sge::image::color::format const _format,
    sge::image2d::pitch const &_pitch)
{
  return sge::image::view::make<sge::image2d::tag>(_data, _dim, _format, _pitch);
}

SGE_IMAGE_IMPL_VIEW_INSTANTIATE_MAKE(sge::image2d::tag);
