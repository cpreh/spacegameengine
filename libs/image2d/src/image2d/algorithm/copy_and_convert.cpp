...
void sge::image2d::algorithm::copy_and_convert(
    sge::image2d::view::const_object const &_src,
    sge::image2d::view::object const &_dest,
    sge::image::algorithm::may_overlap const _overlap,
    sge::image::algorithm::uninitialized const _uninitialized)
{
  sge::image::algorithm::copy_and_convert<sge::image2d::tag>(_src, _dest, _overlap, _uninitialized);
}

SGE_IMAGE_IMPL_ALGORITHM_INSTANTIATE_COPY_AND_CONVERT(sge::image2d::tag);
