...
using to_static_format = sge::image::view::basic_format<
    sge::image::traits::image::dimension<Tag>::value,
    sge::image::impl::pixel::
        to_static_format<sge::image::traits::image::color_tag<Tag>, FormatEnum>>;
