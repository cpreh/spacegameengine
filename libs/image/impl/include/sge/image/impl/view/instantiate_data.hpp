...
#define SGE_IMAGE_IMPL_VIEW_INSTANTIATE_DATA_BASE(tag, view_type, pointer) \
  template SGE_CORE_IMPL_EXPORT_FUNCTION_INSTANTIATION pointer sge::image::view::data<tag>( \
      sge::image::view::view_type<tag> const &)

#define SGE_IMAGE_IMPL_VIEW_INSTANTIATE_DATA(tag) \
  SGE_IMAGE_IMPL_VIEW_INSTANTIATE_DATA_BASE(tag, object, sge::image::raw_pointer); \
  SGE_IMAGE_IMPL_VIEW_INSTANTIATE_DATA_BASE(tag, const_object, sge::image::const_raw_pointer)
