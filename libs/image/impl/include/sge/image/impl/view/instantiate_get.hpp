...
#ifndef SGE_IMAGE_IMPL_VIEW_INSTANTIATE_GET_HPP_INCLUDED
#define SGE_IMAGE_IMPL_VIEW_INSTANTIATE_GET_HPP_INCLUDED
...
#define SGE_IMAGE_IMPL_VIEW_INSTANTIATE_GET_BASE(\
	tag,\
	view_type\
)\
template \
...
#define SGE_IMAGE_IMPL_VIEW_INSTANTIATE_GET(\
	tag\
)\
SGE_IMAGE_IMPL_VIEW_INSTANTIATE_CONST_NONCONST(\
	tag,\
	SGE_IMAGE_IMPL_VIEW_INSTANTIATE_GET_BASE\
)
