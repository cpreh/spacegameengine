...
inline void copy_and_convert_dynamic(
    sge::image::view::const_object<Tag> const &_src,
    sge::image::view::object<Tag> const &_dest,
    sge::image::algorithm::may_overlap const _overlap,
    sge::image::algorithm::uninitialized const _uninitialized)
{
  sge::image::impl::traits::dynamic_copy_and_convert<sge::image::traits::image::color_tag<Tag>>::
      template execute<Tag>(_src, _dest, _overlap, _uninitialized);
}
