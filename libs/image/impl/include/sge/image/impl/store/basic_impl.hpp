...
sge::image::store::basic<Format>::basic(internal_type &&_internal) : internal_(std::move(_internal))
{
}

template <typename Format>
sge::image::store::basic<Format>::basic(dim const &_size, fcppt::no_init const &)
    : internal_(sge::image::impl::to_mizuiro_dim(_size), mizuiro::no_init{})
{
}

template <typename Format>
sge::image::store::basic<Format>::basic(dim const &_size, mizuiro_color const &_init)
    : internal_{sge::image::impl::to_mizuiro_dim(_size), _init}
{
}

template <typename Format>
sge::image::store::basic<Format>::basic(dim const &_size, init_function const &_init)
    : basic(_size, fcppt::no_init{})
{
  _init(this->view());
}

template <typename Format>
sge::image::store::basic<Format>::basic(basic const &) = default;

template <typename Format>
sge::image::store::basic<Format>::basic(basic &&) noexcept = default;

template <typename Format>
sge::image::store::basic<Format> &
sge::image::store::basic<Format>::operator=(basic const &) = default;

template <typename Format>
sge::image::store::basic<Format> &
sge::image::store::basic<Format>::operator=(basic &&) noexcept = default;

namespace sge::image::store
{
template <typename Format>
basic<Format>::~basic() = default;
}
