...
#ifndef SGE_IMAGE_IMPL_STORE_INSTANTIATE_OBJECT_CTOR_HPP_INCLUDED
#define SGE_IMAGE_IMPL_STORE_INSTANTIATE_OBJECT_CTOR_HPP_INCLUDED
...
#define SGE_IMAGE_IMPL_STORE_INSTANTIATE_OBJECT_CTOR(\
	format_arg,\
	args\
) \
template \
