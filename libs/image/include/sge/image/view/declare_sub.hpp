...
#define SGE_IMAGE_VIEW_DECLARE_SUB(tag) \
  ...
  sge::image::view::sub(sge::image::view::object<tag> const &, sge::image::box<tag> const &); \
\
  extern template SGE_IMAGE_DETAIL_INSTANTIATE_SYMBOL sge::image::view::const_object<tag> \
  sge::image::view::sub(sge::image::view::const_object<tag> const &, sge::image::box<tag> const &)
