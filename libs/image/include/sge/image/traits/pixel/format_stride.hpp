...
inline sge::image::size_type format_stride(sge::image::traits::pixel::format<Tag> const _format)
{
  return sge::image::traits::pixel::format_stride_tpl<Tag>::execute(_format);
}
