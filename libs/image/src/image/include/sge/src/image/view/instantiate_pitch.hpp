...
#ifndef SGE_SRC_IMAGE_VIEW_INSTANTIATE_PITCH_HPP_INCLUDED
#define SGE_SRC_IMAGE_VIEW_INSTANTIATE_PITCH_HPP_INCLUDED
...
#define SGE_SRC_IMAGE_VIEW_INSTANTIATE_PITCH_BASE(\
	tag,\
	view_type\
)\
template \
...
#define SGE_SRC_IMAGE_VIEW_INSTANTIATE_PITCH(\
	tag\
)\
SGE_SRC_IMAGE_VIEW_INSTANTIATE_CONST_NONCONST(\
	tag,\
	SGE_SRC_IMAGE_VIEW_INSTANTIATE_PITCH_BASE\
)
