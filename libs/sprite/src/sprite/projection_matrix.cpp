...
sge::sprite::projection_matrix(sge::renderer::target::viewport const &_viewport)
{
  return sge::renderer::projection::orthogonal_viewport(
      _viewport, sge::sprite::projection_matrix_near(), sge::sprite::projection_matrix_far());
}
