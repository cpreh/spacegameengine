...
sge::renderer::state::core::blend::object_unique_ptr sge::sprite::state::with_blend::make(
    sge::renderer::device::core_ref const _device,
    sge::sprite::state::with_blend::optional_extra_parameters const &_write_mask)
{
  return _device.get().create_blend_state(sge::renderer::state::core::blend::parameters(
      ...
      fcppt::optional::from(
          _write_mask, [] { return sge::renderer::state::core::blend::write_mask_all(); })));
}

void sge::sprite::state::with_blend::set(
    sge::renderer::context::core &_context,
    fcppt::reference<sge::renderer::state::core::blend::object const> const _state)
{
  _context.blend_state(sge::renderer::state::core::blend::const_optional_object_ref(_state));
}

void sge::sprite::state::with_blend::unset(sge::renderer::context::core &_context)
{
  _context.blend_state(sge::renderer::state::core::blend::const_optional_object_ref());
}
