...
sge::sprite::projection_matrix_fixed(sge::sprite::projection_dim const &_size)
{
  return fcppt::math::dim::contents(_size.get()) != 0U
             ? sge::sprite::optional_matrix(sge::renderer::projection::orthogonal_wh(
                   fcppt::math::dim::structure_cast<
                       sge::renderer::projection::dim,
                       fcppt::cast::int_to_float_fun>(_size.get()),
