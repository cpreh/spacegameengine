...
template <typename Choices, typename StateChoices>
void range_with_options(
    sge::sprite::state::render_context<StateChoices> &_render_context,
    sge::renderer::vertex::declaration const &_vertex_declaration,
    sge::sprite::render::range<Choices> const &_range,
    sge::sprite::state::object<StateChoices> &_states,
    sge::sprite::state::options<StateChoices> const &_options)
{
  fcppt::optional::maybe_void(
      _range.object(),
      [&_render_context, &_vertex_declaration, &_range, &_states, &_options](
          fcppt::reference<sge::sprite::detail::render::range_object<Choices> const> const
              _range_object)
      {
        sge::sprite::state::scoped<StateChoices> const states(
            _states.renderer(), fcppt::make_ref(_render_context), _options, _states);
        ...
        sge::sprite::detail::render::scoped_vertex const scoped_vertex(
            ...
            fcppt::make_cref(_vertex_declaration),
            fcppt::make_cref(*fcppt::record::get<sge::sprite::buffers::roles::vertex_buffer>(
                _range_object.get())),
            _options.vertex_options());

        sge::sprite::detail::render::range(_render_context, _range_object.get(), _range.parts());
      });
}
