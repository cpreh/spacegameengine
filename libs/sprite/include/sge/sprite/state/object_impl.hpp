...
sge::sprite::state::object<StateChoices>::object(
    fcppt::reference<render_device> const _renderer, parameters_type const &_parameters)
    : renderer_(_renderer),
      elements_(
          sge::sprite::state::detail::make_objects<StateChoices>(_renderer, _parameters.elements()))
{
}
...
{
template <typename StateChoices>
object<StateChoices>::~object() = default;
}
