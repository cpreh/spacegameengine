...
struct with_blend
{
  using role = sge::sprite::state::roles::blend;

  using parameter_role = sge::sprite::state::roles::blend_write_mask;
  ...
  using state_type = sge::renderer::state::core::blend::object_unique_ptr;

  using optional_extra_parameters =
      fcppt::optional::object<sge::renderer::state::core::blend::write_mask>;

  SGE_SPRITE_DETAIL_SYMBOL
  static sge::renderer::state::core::blend::object_unique_ptr make(
