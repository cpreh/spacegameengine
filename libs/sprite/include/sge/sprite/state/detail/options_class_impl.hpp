...
private:
  ...
  using has_option =
      std::conjunction<std::negation<typename Type::persistent>, typename Type::has_parameter>;

  template <typename Type>
  using option_class_element =
      fcppt::record::element<typename Type::option_role, typename Type::optional_extra_option>;

public:
  using type = fcppt::record::from_list<fcppt::mpl::list::append<
      fcppt::mpl::list::map<
          fcppt::mpl::list::
              keep_if<typename StateChoices::optional_elements, fcppt::mpl::lambda<has_option>>,
          fcppt::mpl::lambda<option_class_element>>,
      fcppt::mpl::list::map<
          typename StateChoices::optional_elements,
          fcppt::mpl::lambda<sge::sprite::state::detail::options_class_element>>>>;
};
