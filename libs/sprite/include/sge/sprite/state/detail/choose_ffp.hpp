...
template <typename StateChoices, typename Type1, typename Type2>
using choose_ffp = std::
    conditional_t<sge::sprite::state::detail::needs_ffp<StateChoices>::type::value, Type1, Type2>;
