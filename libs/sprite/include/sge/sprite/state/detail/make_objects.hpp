...
inline sge::sprite::state::detail::object_class<StateChoices> make_objects(
    fcppt::reference<sge::sprite::state::render_device<StateChoices>> const _device,
    sge::sprite::state::detail::parameters_class<StateChoices> const &_parameters)
{
  return fcppt::record::init<sge::sprite::state::detail::object_class<StateChoices>>(
      sge::sprite::state::detail::make_one_object<StateChoices>(_device, _parameters));
}
