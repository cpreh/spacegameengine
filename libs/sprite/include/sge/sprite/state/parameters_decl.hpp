...
class parameters
{
  using elements_type = sge::sprite::state::detail::parameters_class<StateChoices>;
...
public:
  ...
  parameters &blend_write_mask(bool);

  parameters &enable_scissor_test(bool);

  template <typename Role>
  parameters &set(fcppt::record::label_value_type<elements_type, Role>);
