...
template <typename Range, typename Buffers, typename Compare>
inline sge::sprite::render::range<typename Buffers::choices>
sort_and_update(Range const &_range, Compare const &_compare, Buffers &_buffers)
{
  sge::sprite::geometry::sort(_range, _compare);
