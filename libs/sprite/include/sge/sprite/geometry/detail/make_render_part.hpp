...
inline sge::sprite::render::range_part<Choices> make_render_part(
    sge::sprite::buffers::slice<Choices> const &_slice,
    sge::sprite::detail::offset const _offset,
    sge::sprite::count const _count,
    sge::sprite::object<Choices> const &_current)
{
  return sge::sprite::render::range_part<Choices>(
      fcppt::record::init<typename sge::sprite::detail::render::range_part_object<Choices>::type>(
          sge::sprite::geometry::detail::render_part_element<Choices>(
              _slice, _offset, _count, _current)));
}
