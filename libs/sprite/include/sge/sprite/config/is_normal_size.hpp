...
template <typename T>
struct is_normal_size : std::false_type
{
};

template <sge::sprite::config::texture_size_option Option>
struct is_normal_size<sge::sprite::config::normal_size<Option>> : std::true_type
{
};
