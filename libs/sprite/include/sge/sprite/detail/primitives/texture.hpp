...
struct texture<Choices, TextureLevels, sge::sprite::config::texture_coordinates::custom, Ownership>
{
  using type = fcppt::mpl::list::append<
      typename sge::sprite::detail::primitives::texture_ptr<Choices, TextureLevels, Ownership>::
          type,
      typename sge::sprite::detail::primitives::texture_coordinates<Choices, TextureLevels>::type>;
};
    ...
    Ownership>
{
  using type = fcppt::mpl::list::append<
      typename sge::sprite::detail::primitives::texture_ptr<Choices, TextureLevels, Ownership>::
          type,
      typename sge::sprite::detail::primitives::texture_repetition<Choices>::type>;
};
