...
using make_texture_levels = fcppt::mpl::list::interval<
    std::integral_constant<sge::sprite::texture_level, 0U>,
    std::integral_constant<sge::sprite::texture_level, Levels::value>>;
