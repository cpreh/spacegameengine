...
template <typename TextureLevels>
void unset_texture_stages(
    sge::renderer::context::core &_render_context // NOLINT(google-runtime-references)
)
{
  sge::sprite::detail::apply_texture_levels<TextureLevels>(
      sge::sprite::detail::render::unset_texture_stage(fcppt::make_ref(_render_context)));
}
