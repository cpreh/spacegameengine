...
void range(
    ...
    sge::sprite::detail::render::range_object<Choices> const &_range_object,
    sge::sprite::render::range_part_vector<Choices> const &_range_parts)
{
  for (auto const &element : _range_parts)
  {
    sge::sprite::detail::render::set_textures(_render_context, element);

    sge::sprite::detail::render::inner(_render_context, _range_object, element);
  }

  sge::sprite::detail::render::unset_textures<Choices>(_render_context);
}
