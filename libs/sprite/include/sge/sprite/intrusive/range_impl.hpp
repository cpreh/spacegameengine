...
sge::sprite::intrusive::range<Choices, IsConst>::range(
    reference const _list, sge::sprite::count const _size)
    : list_(_list), size_(_size)
{
}
...
template <typename Choices, bool IsConst>
sge::sprite::count sge::sprite::intrusive::range<Choices, IsConst>::size() const
{
  return size_;
}

template <typename Choices, bool IsConst>
bool sge::sprite::intrusive::range<Choices, IsConst>::empty() const
{
  return list_.get().empty();
}

template <typename Choices, bool IsConst>
template <typename Equal>
void sge::sprite::intrusive::range<Choices, IsConst>::sort(Equal const &_equal) const
{
  list_.get().sort(_equal);
}
