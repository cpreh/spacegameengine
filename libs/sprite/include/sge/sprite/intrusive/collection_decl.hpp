...
public:
  ...
  [[nodiscard]] connection_ref connection();

  using range_type = sge::sprite::intrusive::range<Choices, false>;

  using const_range_type = sge::sprite::intrusive::range<Choices, true>;
...
private:
  ...
  using connection_impl = sge::sprite::intrusive::detail::connection<Choices>;
