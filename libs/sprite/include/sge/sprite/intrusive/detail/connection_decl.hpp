...
class connection : public sge::sprite::intrusive::connection<Choices>
{
...
public:
  ...
  using list_ref = fcppt::reference<list>;

  using count_ref = fcppt::reference<sge::sprite::count>;

  connection(list_ref, count_ref);
