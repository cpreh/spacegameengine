...
{
  using range_iterator_traits = std::iterator_traits<
      sge::sprite::intrusive::ordered::detail::range_iterator<Choices, IsConst>>;

  using type = boost::iterator_facade<
      sge::sprite::intrusive::ordered::iterator<Choices, Order, IsConst>,
