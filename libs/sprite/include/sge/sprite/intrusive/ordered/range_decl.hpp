...
public:
  using ordered_map_reference =
      fcppt::reference<std::conditional_t<IsConst, ordered_map const, ordered_map>>;

  using iterator = sge::sprite::intrusive::ordered::iterator<Choices, Order, IsConst>;

  explicit range(ordered_map_reference);
