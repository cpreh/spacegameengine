...
class iterator final
    : public sge::sprite::intrusive::ordered::detail::iterator_base<Choices, Order, IsConst>
{
  using base = sge::sprite::intrusive::ordered::detail::iterator_base<Choices, Order, IsConst>;

  using ordered_map = sge::sprite::intrusive::ordered::detail::map<Order, Choices>;

  using ordered_map_iterator = std::
...
private:
  ...
  using filtered_ordered_map_iterator = boost::filter_iterator<
      sge::sprite::intrusive::ordered::detail::iterator_empty,
      ordered_map_iterator>;

  filtered_ordered_map_iterator outer_iterator_;

  using range_iterator = sge::sprite::intrusive::ordered::detail::range_iterator<Choices, IsConst>;
