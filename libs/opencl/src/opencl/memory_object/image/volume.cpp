...
sge::opencl::memory_object::image::volume::volume(
    ...
    : impl_(),
      image_format_(),
      size_(fcppt::math::dim::structure_cast<sge::opencl::dim3, fcppt::cast::size_fun>(
...
cl_image_format const &sge::opencl::memory_object::image::volume::image_format() const
{
  return image_format_;
}

sge::opencl::dim3 const &sge::opencl::memory_object::image::volume::size() const { return size_; }
