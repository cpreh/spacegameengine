...
sge::opencl::single_device_system::parameters::parameters()
    : renderer_(),
      error_callback_(),
      profiling_(sge::opencl::command_queue::profiling_mode::disabled),
      execution_mode_(sge::opencl::command_queue::execution_mode::in_order),
      prefers_gpu_(false)
{
}
...
{
  renderer_ = sge::opencl::single_device_system::optional_renderer(_renderer);
...
sge::opencl::single_device_system::parameters &
sge::opencl::single_device_system::parameters::prefer_gpu(bool const _prefers_gpu)
{
  prefers_gpu_ = _prefers_gpu;
  return *this;
}
...
{
  execution_mode_ = _execution_mode;
  return *this;
}
...
bool sge::opencl::single_device_system::parameters::prefers_gpu() const { return prefers_gpu_; }
