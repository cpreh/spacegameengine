...
public:
  ...
  SGE_OPENCL_DETAIL_SYMBOL
  parameters &renderer(sge::renderer::device::core_ref);

  SGE_OPENCL_DETAIL_SYMBOL
  parameters &enable_profiling();

  SGE_OPENCL_DETAIL_SYMBOL
  parameters &context_error_callback(sge::opencl::context::error_callback const &);

  SGE_OPENCL_DETAIL_SYMBOL
  parameters &prefer_gpu(bool);

  SGE_OPENCL_DETAIL_SYMBOL
  parameters &execution_mode(sge::opencl::command_queue::execution_mode);
  ...
  [[nodiscard]] SGE_OPENCL_DETAIL_SYMBOL sge::opencl::command_queue::profiling_mode
  profiling() const;

  [[nodiscard]] SGE_OPENCL_DETAIL_SYMBOL sge::opencl::command_queue::execution_mode
  execution_mode() const;

  [[nodiscard]] SGE_OPENCL_DETAIL_SYMBOL bool prefers_gpu() const;
