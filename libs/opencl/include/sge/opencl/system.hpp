...
public:
  ...
  [[nodiscard]] SGE_OPENCL_DETAIL_SYMBOL sge::opencl::platform::object_sequence &platforms();

  [[nodiscard]] SGE_OPENCL_DETAIL_SYMBOL sge::opencl::platform::object_sequence const &
  platforms() const;
