...
class wrapped_system : public sge::systems::impl::window::system_base
{
  FCPPT_NONMOVABLE(wrapped_system);

public:
  explicit wrapped_system(sge::systems::wrapped_window const &);
