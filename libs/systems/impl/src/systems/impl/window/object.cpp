...
sge::systems::impl::window::object::~object() = default;

sge::window::object &sge::systems::impl::window::object::get() const { return base_->get(); }

void sge::systems::impl::window::object::post_init() const
{
  if (show_on_post_)
  {
    this->get().show();
