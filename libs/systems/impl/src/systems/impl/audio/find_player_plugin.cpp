...
sge::systems::impl::audio::player_pair sge::systems::impl::audio::find_player_plugin(
    fcppt::log::context_reference const _log_context,
    fcppt::log::object &_log,
    sge::audio::player_plugin::collection const &_collection,
    sge::systems::audio_player const &_parameters)
{
  return _parameters.name().has_value()
             ? sge::systems::impl::find_plugin<sge::audio::player>(
                   _log_context,
                   _collection,
                   _parameters.name(),
                   [](sge::audio::player const &) { return true; })
             : fcppt::optional::from(
                   sge::systems::impl::find_plugin_opt<sge::audio::player>(
                       _log_context,
                       _collection,
                       [](sge::audio::player const &_player) { return !_player.is_null(); }),
                   [&_log_context, &_log, &_collection, &_parameters]
                   {
                     ...
                     return sge::systems::impl::find_plugin<sge::audio::player>(
                         _log_context,
                         _collection,
                         _parameters.name(),
                         [](sge::audio::player const &_player) { return _player.is_null(); });
