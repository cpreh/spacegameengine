...
sge::systems::impl::audio::loader::loader(
    ...
    : audio_multi_loader_(
          fcppt::make_unique_ptr<sge::audio::multi_loader>(sge::audio::multi_loader_parameters(
              _log_context,
              _collection,
...
sge::systems::impl::audio::loader::~loader() = default;

sge::audio::loader &sge::systems::impl::audio::loader::get() const { return *audio_multi_loader_; }
