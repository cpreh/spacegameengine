...
{
  return SGE_PLUGIN_IMPL_ADDRESS_NAME("create_audio_loader");
}

sge::plugin::capabilities sge::plugin::detail::traits<sge::audio::loader>::plugin_type()
{
  return sge::plugin::capabilities::audio_loader;
}
