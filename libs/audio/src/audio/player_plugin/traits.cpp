...
{
  return SGE_PLUGIN_IMPL_ADDRESS_NAME("create_audio_player");
}

sge::plugin::capabilities sge::plugin::detail::traits<sge::audio::player>::plugin_type()
{
  return sge::plugin::capabilities::audio_player;
}
