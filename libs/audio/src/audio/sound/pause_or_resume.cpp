...
void sge::audio::sound::pause_or_resume(
    sge::audio::sound::base &_sound, sge::audio::sound::do_pause const _do_pause)
{
  if (_do_pause.get())
  {
    sge::audio::sound::pause(_sound);
  }
  else
  {
    sge::audio::sound::resume(_sound);
  }
}
