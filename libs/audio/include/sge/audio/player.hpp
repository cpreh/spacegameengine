...
public:
  [[nodiscard]] virtual sge::audio::listener &listener() = 0;
  ...
  /**
	 ...
	 */
  virtual void gain(sge::audio::scalar) = 0;

  /// Create a buffer from a file
  [[nodiscard]] virtual sge::audio::buffer_unique_ptr
  create_buffer(sge::audio::file & // NOLINT(google-runtime-references)
                ) = 0; // NOLINT(google-runtime-references)

  /// Create a positional stream from a file
  [[nodiscard]] virtual sge::audio::sound::positional_unique_ptr create_positional_stream(
      sge::audio::file_ref, sge::audio::sound::positional_parameters const &) = 0;

  /// Create a nonpositional stream from a file
  [[nodiscard]] virtual sge::audio::sound::base_unique_ptr create_nonpositional_stream(
      sge::audio::file_ref, sge::audio::sound::nonpositional_parameters const &) = 0;
