 ...
 */
class SGE_CORE_DETAIL_CLASS_SYMBOL positional : public sge::audio::sound::base
{
...
public:
  ...
  virtual void rolloff_factor(sge::audio::scalar) = 0;

  /// Sets the reference distance (see \ref audio_positional)
  virtual void reference_distance(sge::audio::scalar) = 0;

  /// Sets the maximum distance (see \ref audio_positional)
  virtual void max_distance(sge::audio::scalar) = 0;

  /// Sets the direction distance (see \ref audio_positional)
  virtual void direction(sge::audio::sound::optional_direction const &) = 0;

  /// Sets the inner cone angle (see \ref audio_positional)
  virtual void inner_cone_angle(sge::audio::scalar) = 0;

  /// Sets the outer cone angle (see \ref audio_positional)
  virtual void outer_cone_angle(sge::audio::scalar) = 0;

  /// Sets the outer cone gain (see \ref audio_positional)
  virtual void outer_cone_gain(sge::audio::scalar) = 0;
};
