...
public:
  ...
  prototype(fcppt::log::context_reference, std::filesystem::path const &);

  [[nodiscard]] SGE_MODEL_OBJ_DETAIL_SYMBOL sge::model::obj::vertex_coordinate_sequence const &
  vertex_coordinates() const;

  [[nodiscard]] SGE_MODEL_OBJ_DETAIL_SYMBOL sge::model::obj::texture_coordinate_sequence const &
  texture_coordinates() const;

  [[nodiscard]] SGE_MODEL_OBJ_DETAIL_SYMBOL sge::model::obj::normal_sequence const &normals() const;

  [[nodiscard]] SGE_MODEL_OBJ_DETAIL_SYMBOL sge::model::obj::face_vertex_sequence const &
  face_vertices() const;

  [[nodiscard]] SGE_MODEL_OBJ_DETAIL_SYMBOL sge::model::obj::material_to_face_sequence const &
  parts() const;

  [[nodiscard]] SGE_MODEL_OBJ_DETAIL_SYMBOL std::size_t face_count() const;

  [[nodiscard]] SGE_MODEL_OBJ_DETAIL_SYMBOL sge::model::obj::material::file_sequence const &
  material_files() const;

  [[nodiscard]] SGE_MODEL_OBJ_DETAIL_SYMBOL sge::model::obj::box const &bounding_box() const;
