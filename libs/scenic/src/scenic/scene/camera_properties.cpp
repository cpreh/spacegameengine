...
sge::scenic::scene::camera_properties::camera_properties(
    ...
    : coordinate_system_(_coordinate_system), fov_(_fov), near_(_near), far_(_far)
{
}
...
sge::renderer::projection::fov const &sge::scenic::scene::camera_properties::fov() const
{
  return fov_;
}

sge::renderer::projection::near const &sge::scenic::scene::camera_properties::near() const
{
  return near_;
}

sge::renderer::projection::far const &sge::scenic::scene::camera_properties::far() const
{
  return far_;
}
