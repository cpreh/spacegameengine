...
public:
  ...
  [[nodiscard]] sge::scenic::render_queue::index_type material() const;

  [[nodiscard]] sge::scenic::render_queue::index_type vertex_buffer() const;

  [[nodiscard]] sge::renderer::matrix4 const &modelview() const;

  [[nodiscard]] sge::renderer::index::buffer &index_buffer() const;

  [[nodiscard]] sge::scenic::index_buffer_range const &index_buffer_range() const;
