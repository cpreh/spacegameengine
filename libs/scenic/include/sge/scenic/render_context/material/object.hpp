...
public:
  ...
  [[nodiscard]] SGE_SCENIC_DETAIL_SYMBOL sge::scenic::render_context::emissive_color const &
  emissive_color() const;

  [[nodiscard]] SGE_SCENIC_DETAIL_SYMBOL sge::scenic::render_context::material::shininess const &
  shininess() const;
  ...
  [[nodiscard]] SGE_SCENIC_DETAIL_SYMBOL bool
  operator==(sge::scenic::render_context::material::object const &) const;
