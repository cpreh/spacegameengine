...
public:
  ...
  [[nodiscard]] SGE_SCENIC_DETAIL_SYMBOL sge::scenic::render_context::light::constant_attenuation
  constant_attenuation() const;

  [[nodiscard]] SGE_SCENIC_DETAIL_SYMBOL sge::scenic::render_context::light::linear_attenuation
  linear_attenuation() const;

  [[nodiscard]] SGE_SCENIC_DETAIL_SYMBOL sge::scenic::render_context::light::quadratic_attenuation
