...
public:
  ...
  object(
      fcppt::reference<sge::scenic::render_context::cg::manager>, sge::renderer::context::core_ref);
  ...
  [[nodiscard]] SGE_SCENIC_DETAIL_SYMBOL sge::renderer::target::base &target() override;

  SGE_SCENIC_DETAIL_SYMBOL
  ~object() override;

private:
  using optional_vertex_buffer = fcppt::optional::reference<sge::renderer::vertex::buffer const>;

  fcppt::reference<sge::scenic::render_context::cg::manager> const manager_;
