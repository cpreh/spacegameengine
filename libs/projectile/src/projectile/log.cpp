...
sge::projectile::log::~log() = default;

fcppt::log::object &sge::projectile::log::world_log() const { return world_log_; }

fcppt::log::object &sge::projectile::log::body_log() const { return body_log_; }

fcppt::log::object &sge::projectile::log::ghost_log() const { return ghost_log_; }

fcppt::log::object &sge::projectile::log::triangle_log() const { return triangle_log_; }
