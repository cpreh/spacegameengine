...
sge::projectile::detail::debug_drawer_impl::debug_drawer_impl(
    ...
    : log_{_log_context, sge::projectile::log_location(), sge::log::default_parameters(fcppt::log::name{FCPPT_TEXT("debug_drawer_impl")})},
      ...
      scoped_lock_()
{
  if (world_.getDebugDrawer() != nullptr)
  {
    throw sge::core::exception{FCPPT_TEXT("projectile debug drawer already set!")};
  }
...
void sge::projectile::detail::debug_drawer_impl::update()
{
  ...
  scoped_lock_ = optional_scoped_lock_unique_ptr();

  FCPPT_LOG_DEBUG(log_, fcppt::log::out << FCPPT_TEXT("released lock"))
}

void sge::projectile::detail::debug_drawer_impl::render(
    sge::renderer::context::core &_render_context)
{
  ...
  line_drawer_.render(_render_context);
}

void sge::projectile::detail::debug_drawer_impl::active(bool const _active)
{
  setDebugMode(
      _active ? btIDebugDraw::DBG_DrawWireframe /* | btIDebugDraw::DBG_DrawAabb*/
              : btIDebugDraw::DBG_NoDebug);
}

bool sge::projectile::detail::debug_drawer_impl::active() const
{
  return debug_mode_ != btIDebugDraw::DBG_NoDebug;
}

sge::projectile::detail::debug_drawer_impl::~debug_drawer_impl() { world_.setDebugDrawer(nullptr); }

void sge::projectile::detail::debug_drawer_impl::drawLine(
    btVector3 const &from, btVector3 const &to, btVector3 const &color)
{
    ...
    btVector3 const &_to_color)
{
  ...
  fcppt::optional::maybe_void(
      scoped_lock_,
      [_from, _to, _from_color, _to_color](scoped_lock_unique_ptr const &_lock)
      {
        auto const make_vector(
            [](btVector3 const &_s) -> sge::renderer::vector3
            {
              return fcppt::math::vector::
                  structure_cast<sge::renderer::vector3, fcppt::cast::size_fun>(
...
void sge::projectile::detail::debug_drawer_impl::drawContactPoint(
...
void sge::projectile::detail::debug_drawer_impl::draw3dText(btVector3 const &, char const *) {}

void sge::projectile::detail::debug_drawer_impl::reportErrorWarning(char const *warningString)
{
  FCPPT_LOG_WARNING(log_, fcppt::log::out << fcppt::from_std_string(warningString))
}

void sge::projectile::detail::debug_drawer_impl::setDebugMode(int const _debug_mode)
{
  debug_mode_ = _debug_mode;
}

int sge::projectile::detail::debug_drawer_impl::getDebugMode() const { return debug_mode_; }
