...
class debug_drawer_impl : public btIDebugDraw
{
  FCPPT_NONMOVABLE(debug_drawer_impl);
...
private:
  ...
  using scoped_lock_unique_ptr = fcppt::unique_ptr<sge::line_drawer::scoped_lock>;
  ...
  void drawLine(
      ...
      btVector3 const &to_color) override;
