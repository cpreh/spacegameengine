...
sge::bvh::object<Traits>::object()
    : leaves_(), representation_(typename traits::node_or_leaf_variant(sge::bvh::empty_node()))
{
}

template <typename Traits>
void sge::bvh::object<Traits>::insert(leaf_sequence const &_leaves)
{
  leaves_.insert(leaves_.end(), _leaves.begin(), _leaves.end());
