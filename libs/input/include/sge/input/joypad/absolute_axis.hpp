...
#include <sge/input/joypad/absolute_axis_fwd.hpp> // IWYU pragma: keep
...
public:
  ...
  absolute_axis(sge::input::joypad::axis_code, sge::input::joypad::absolute_axis_id);

  [[nodiscard]] SGE_INPUT_DETAIL_SYMBOL sge::input::joypad::axis_code code() const;

  [[nodiscard]] SGE_INPUT_DETAIL_SYMBOL sge::input::joypad::absolute_axis_id id() const;
