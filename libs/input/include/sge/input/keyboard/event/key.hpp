...
class SGE_CORE_DETAIL_CLASS_SYMBOL key : public sge::input::keyboard::event::base
{
  FCPPT_NONMOVABLE(key);

public:
  SGE_INPUT_DETAIL_SYMBOL
  key(sge::input::keyboard::shared_ptr,
  ...
  [[nodiscard]] SGE_INPUT_DETAIL_SYMBOL sge::input::keyboard::key const &get() const;
