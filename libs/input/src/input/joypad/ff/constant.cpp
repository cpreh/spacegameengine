...
sge::input::joypad::ff::constant::constant(
    ...
    : magnitude_{_magnitude}, envelope_{_envelope}
{
}

sge::input::joypad::ff::magnitude sge::input::joypad::ff::constant::magnitude() const
{
  return magnitude_;
}

sge::input::joypad::ff::envelope const &sge::input::joypad::ff::constant::envelope() const
{
  return envelope_;
}
