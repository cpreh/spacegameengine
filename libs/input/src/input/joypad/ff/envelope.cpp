...
sge::input::joypad::ff::envelope::envelope(
    ...
    : attack_level_{_attack_level},
      attack_time_{_attack_time},
      fade_level_{_fade_level},
      fade_time_{_fade_time}
{
}

sge::input::joypad::ff::attack_level sge::input::joypad::ff::envelope::attack_level() const
{
  return attack_level_;
}

sge::input::joypad::ff::attack_time sge::input::joypad::ff::envelope::attack_time() const
{
  return attack_time_;
}

sge::input::joypad::ff::fade_level sge::input::joypad::ff::envelope::fade_level() const
{
  return fade_level_;
}

sge::input::joypad::ff::fade_time sge::input::joypad::ff::envelope::fade_time() const
{
  return fade_time_;
}
