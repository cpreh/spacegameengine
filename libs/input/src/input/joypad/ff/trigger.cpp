...
sge::input::joypad::ff::trigger::trigger(
    ...
    : button_{_button}, cooldown_{_cooldown}
{
}

sge::input::joypad::button_id sge::input::joypad::ff::trigger::button() const { return button_; }

sge::input::joypad::ff::trigger_cooldown sge::input::joypad::ff::trigger::cooldown() const
{
  return cooldown_;
}
