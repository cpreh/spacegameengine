...
sge::input::joypad::ff::waveform sge::input::joypad::ff::periodic::waveform() const
{
  return waveform_;
}

sge::input::joypad::ff::magnitude sge::input::joypad::ff::periodic::magnitude() const
{
  return magnitude_;
}

sge::input::joypad::ff::offset sge::input::joypad::ff::periodic::offset() const { return offset_; }

sge::input::joypad::ff::phase sge::input::joypad::ff::periodic::phase() const { return phase_; }

sge::input::joypad::ff::period sge::input::joypad::ff::periodic::period() const { return period_; }

sge::input::joypad::ff::envelope const &sge::input::joypad::ff::periodic::envelope() const
{
  return envelope_;
}
