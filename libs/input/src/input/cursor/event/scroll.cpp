...
sge::input::cursor::event::scroll::scroll(
    ...
    : sge::input::cursor::event::scroll::base{std::move(_cursor)}, code_{_code}, value_{_value}
{
}

sge::input::cursor::event::scroll::~scroll() = default;

sge::input::cursor::scroll_code sge::input::cursor::event::scroll::code() const { return code_; }

sge::input::cursor::scroll_value sge::input::cursor::event::scroll::value() const { return value_; }
