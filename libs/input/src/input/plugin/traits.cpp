...
{
  return SGE_PLUGIN_IMPL_ADDRESS_NAME("create_input_system");
}

sge::plugin::capabilities sge::plugin::detail::traits<sge::input::system>::plugin_type()
{
  return sge::plugin::capabilities::input;
}
