...
sge::input::key::optional_digit sge::input::key::code_to_digit(sge::input::key::code const _code)
{
#define CONVERT_KEYCODE_TO_DIGIT(num) \
  case sge::input::key::code::_##num: \
    return sge::input::key::optional_digit(sge::input::key::digit(num##u))
