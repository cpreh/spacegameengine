...
sge::plugin::collection<Type>::collection(sge::plugin::category_array const &_plugins)
    : plugins_{_plugins}
{
}

template <typename Type>
sge::plugin::collection<Type>::collection(collection const &) = default;

template <typename Type>
sge::plugin::collection<Type>::collection(collection &&) noexcept = default;

template <typename Type>
sge::plugin::collection<Type> &
sge::plugin::collection<Type>::operator=(collection const &) = default;

template <typename Type>
sge::plugin::collection<Type> &
sge::plugin::collection<Type>::operator=(collection &&) noexcept = default;

namespace sge::plugin
{
template <typename Type>
collection<Type>::~collection() = default;
}
