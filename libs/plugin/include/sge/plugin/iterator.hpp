...
template <typename T>
class iterator final : public sge::plugin::detail::iterator_base_type<T>
{
public:
  ...
  [[nodiscard]] SGE_PLUGIN_DETAIL_INSTANTIATE_SYMBOL bool equal(iterator const &) const;

  [[nodiscard]] SGE_PLUGIN_DETAIL_INSTANTIATE_SYMBOL reference dereference() const;
