...
public:
  using loader_function = sge::plugin::loader_function<Type>;

  using library_shared_ptr = fcppt::shared_ptr<sge::plugin::library::object>;

  SGE_PLUGIN_DETAIL_INSTANTIATE_SYMBOL
  explicit object(library_shared_ptr);
  ...
  [[nodiscard]] SGE_PLUGIN_DETAIL_INSTANTIATE_SYMBOL loader_function get() const;
