...
sge::plugin::library::function_base_pair sge::plugin::library::detail::make_version_function(
    sge::plugin::library::detail::version_function const _function)
{
  return sge::plugin::library::function_base_pair{
      sge::plugin::impl::library::version_function_name(),
      sge::plugin::impl::library::to_function_base_unsafe(_function)};
}
