...
sge::plugin::name const &sge::plugin::info::name() const { return name_; }

sge::plugin::description const &sge::plugin::info::description() const { return description_; }

sge::plugin::version sge::plugin::info::version() const { return version_; }

sge::plugin::min_core_version sge::plugin::info::min_core_version() const
{
  return min_core_version_;
}

sge::plugin::capabilities_field const &sge::plugin::info::capabilities() const
{
  return capabilities_;
}

sge::plugin::flags_field const &sge::plugin::info::flags() const { return flags_; }
