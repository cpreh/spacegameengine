...
public:
  ...
  [[nodiscard]] SGE_RENDERER_DETAIL_SYMBOL sge::renderer::state::core::rasterizer::cull_mode
  cull_mode() const;

  [[nodiscard]] SGE_RENDERER_DETAIL_SYMBOL sge::renderer::state::core::rasterizer::fill_mode
  fill_mode() const;
