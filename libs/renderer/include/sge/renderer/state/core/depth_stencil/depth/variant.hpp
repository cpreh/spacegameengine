...
#include <sge/renderer/state/core/depth_stencil/depth/enabled.hpp> // IWYU pragma: keep
#include <sge/renderer/state/core/depth_stencil/depth/off.hpp> // IWYU pragma: keep
