...
#ifndef SGE_RENDERER_STATE_CORE_DEPTH_STENCIL_STENCIL_READ_MASK_HPP_INCLUDED
...
FCPPT_DECLARE_STRONG_TYPEDEF(sge::renderer::state::core::depth_stencil::stencil::value, read_mask);
