...
#include <sge/renderer/state/core/depth_stencil/stencil/combined.hpp> // IWYU pragma: keep
#include <sge/renderer/state/core/depth_stencil/stencil/enabled_variant_fwd.hpp> // IWYU pragma: export
#include <sge/renderer/state/core/depth_stencil/stencil/separate.hpp> // IWYU pragma: keep
