...
#include <sge/renderer/state/core/depth_stencil/stencil/enabled_fwd.hpp> // IWYU pragma: keep
...
public:
  ...
  [[nodiscard]] SGE_RENDERER_DETAIL_SYMBOL sge::renderer::state::core::depth_stencil::stencil::ref
  ref() const;
