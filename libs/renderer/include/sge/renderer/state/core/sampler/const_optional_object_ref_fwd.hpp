...
#ifndef SGE_RENDERER_STATE_CORE_SAMPLER_CONST_OPTIONAL_OBJECT_REF_FWD_HPP_INCLUDED
...
using const_optional_object_ref =
    fcppt::optional::reference<sge::renderer::state::core::sampler::object const>;
