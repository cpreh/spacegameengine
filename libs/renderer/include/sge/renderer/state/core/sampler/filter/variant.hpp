...
#include <sge/renderer/state/core/sampler/filter/anisotropic/parameters.hpp> // IWYU pragma: keep
#include <sge/renderer/state/core/sampler/filter/normal/parameters.hpp> // IWYU pragma: keep
