...
#include <sge/renderer/state/ffp/sampler/binary_op_fwd.hpp> // IWYU pragma: keep
...
public:
  ...
  [[nodiscard]] SGE_RENDERER_DETAIL_SYMBOL sge::renderer::state::ffp::sampler::binary_op_type
  type() const;
