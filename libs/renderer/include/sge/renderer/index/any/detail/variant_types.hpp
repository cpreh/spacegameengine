...
using variant_types = fcppt::mpl::list::map<
    fcppt::mpl::list::enum_range<sge::renderer::index::dynamic::format>,
    fcppt::mpl::bind<
        fcppt::mpl::lambda<sge::renderer::index::any::detail::make_view_element>,
        fcppt::mpl::arg<1>,
