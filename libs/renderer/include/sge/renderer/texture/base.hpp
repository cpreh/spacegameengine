...
public:
  ...
  [[nodiscard]] virtual sge::renderer::texture::capabilities_field capabilities() const = 0;

  [[nodiscard]] virtual sge::renderer::texture::mipmap::object mipmap() const = 0;

  [[nodiscard]] virtual sge::renderer::texture::mipmap::level_count levels() const = 0;
