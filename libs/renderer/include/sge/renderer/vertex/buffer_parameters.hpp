...
#include <sge/renderer/vertex/buffer_parameters_fwd.hpp> // IWYU pragma: keep
...
public:
  ...
  [[nodiscard]] SGE_RENDERER_DETAIL_SYMBOL sge::renderer::vertex::declaration const &
  declaration() const;

  [[nodiscard]] SGE_RENDERER_DETAIL_SYMBOL sge::renderer::vf::dynamic::part_index part() const;

  [[nodiscard]] SGE_RENDERER_DETAIL_SYMBOL sge::renderer::vertex::count count() const;

  [[nodiscard]] SGE_RENDERER_DETAIL_SYMBOL sge::renderer::resource_flags_field flags() const;
