...
public:
  using impl = sge::renderer::buffer::scoped_lock<sge::renderer::vertex::tag>;
  ...
  scoped_lock(sge::renderer::vertex::buffer_ref, sge::renderer::lock_mode);

  SGE_RENDERER_DETAIL_SYMBOL
  scoped_lock(sge::renderer::vertex::buffer_ref, lock_area const &, sge::renderer::lock_mode);
