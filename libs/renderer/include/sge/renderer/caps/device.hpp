...
public:
  ...
  /**
	...
	*/
  [[nodiscard]] SGE_RENDERER_DETAIL_SYMBOL sge::renderer::caps::driver_name const &
  driver_name() const;
  ...
  /**
	...
	card.
	*/
  [[nodiscard]] SGE_RENDERER_DETAIL_SYMBOL sge::renderer::caps::description const &
  description() const;
  ...
  /**
	...
	Y values are in [-1,1].
	*/
  [[nodiscard]] SGE_RENDERER_DETAIL_SYMBOL sge::renderer::caps::normalized_cvv
  ...
  /**
	...
	(8192,8192).
	*/
  [[nodiscard]] SGE_RENDERER_DETAIL_SYMBOL sge::renderer::caps::max_texture_size const &
  ...
  /**
	...
	*/
  [[nodiscard]] SGE_RENDERER_DETAIL_SYMBOL sge::renderer::caps::max_volume_texture_extent
  ...
  /**
	...
	power of 2 textures.
	*/
  [[nodiscard]] SGE_RENDERER_DETAIL_SYMBOL sge::renderer::caps::non_power_of_2_textures
  ...
  /**
	...
	*/
  [[nodiscard]] SGE_RENDERER_DETAIL_SYMBOL sge::renderer::caps::max_anisotropy
  ...
  /**
	...
	*/
  [[nodiscard]] SGE_RENDERER_DETAIL_SYMBOL sge::renderer::caps::render_target_supported
  ...
  /**
	...
	meaning.
	*/
  [[nodiscard]] SGE_RENDERER_DETAIL_SYMBOL sge::renderer::caps::render_target_inverted
  ...
  /**
	...
	*/
  [[nodiscard]] SGE_RENDERER_DETAIL_SYMBOL sge::renderer::caps::clip_plane_indices
  ...
  /**
	...
	*/
  [[nodiscard]] SGE_RENDERER_DETAIL_SYMBOL sge::renderer::caps::light_indices light_indices() const;
  ...
  /**
	...
	*/
  [[nodiscard]] SGE_RENDERER_DETAIL_SYMBOL sge::renderer::caps::texture_stages
  ...
  /**
	...
	*/
  [[nodiscard]] SGE_RENDERER_DETAIL_SYMBOL sge::renderer::caps::target_surface_indices
  ...
  /**
	...
	*/
  [[nodiscard]] SGE_RENDERER_DETAIL_SYMBOL sge::renderer::caps::srgb_framebuffer
