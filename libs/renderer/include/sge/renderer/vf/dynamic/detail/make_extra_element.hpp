...
inline sge::renderer::vf::dynamic::vector
make_extra_element(sge::renderer::vf::vector<Format, NumSubElements> const &)
{
  return sge::renderer::vf::dynamic::detail::make_vector<Format, NumSubElements>();
}

template <typename ColorChannel, typename ColorLayout>
inline sge::renderer::vf::dynamic::color
make_extra_element(mizuiro::color::format::homogenous_static<ColorChannel, ColorLayout> const &)
{
  return sge::renderer::vf::dynamic::detail::make_color<
