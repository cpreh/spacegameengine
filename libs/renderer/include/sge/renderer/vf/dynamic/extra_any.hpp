...
#ifndef SGE_RENDERER_VF_DYNAMIC_EXTRA_ANY_HPP_INCLUDED
#define SGE_RENDERER_VF_DYNAMIC_EXTRA_ANY_HPP_INCLUDED

#include <sge/renderer/vf/dynamic/color.hpp> // IWYU pragma: keep
#include <sge/renderer/vf/dynamic/extra_any_fwd.hpp> // IWYU pragma: export
#include <sge/renderer/vf/dynamic/vector.hpp> // IWYU pragma: keep
