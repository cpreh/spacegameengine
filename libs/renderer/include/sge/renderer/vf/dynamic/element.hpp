...
public:
  ...
  explicit element(sge::renderer::vf::dynamic::any const &);

  [[nodiscard]] SGE_RENDERER_DETAIL_SYMBOL sge::renderer::vf::dynamic::any const &info() const;
...
SGE_RENDERER_DETAIL_SYMBOL
bool operator==(
    sge::renderer::vf::dynamic::element const &, sge::renderer::vf::dynamic::element const &);
