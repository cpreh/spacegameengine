...
public:
  ...
  SGE_RENDERER_DETAIL_SYMBOL
  void lock(sge::renderer::vf::dynamic::locked_part const &);
...
private:
  ...
  using optional_locked_part = fcppt::optional::object<sge::renderer::vf::dynamic::locked_part>;

  optional_locked_part locked_part_;

  using converter_unique_ptr =
      fcppt::unique_ptr<sge::renderer::vf::dynamic::detail::converter_impl>;

  using optional_converter_unique_ptr = fcppt::optional::object<converter_unique_ptr>;
