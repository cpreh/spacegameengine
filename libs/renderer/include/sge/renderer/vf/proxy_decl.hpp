...
public:
  ...
  proxy &operator=(vertex_type const &);

  template <typename Label>
  void set(sge::renderer::vf::label_value_type<Part, Label> const &);

  template <typename Label>
  [[nodiscard]] sge::renderer::vf::label_value_type<Part, Label> get() const;
