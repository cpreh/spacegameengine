...
#include <sge/renderer/color_buffer/volume.hpp> // IWYU pragma: keep
...
SGE_RENDERER_BUFFER_DETAIL_DECLARE_READABLE(sge::renderer::color_buffer::tag_from_dimension<3U>);
