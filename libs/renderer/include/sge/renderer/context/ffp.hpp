...
class SGE_CORE_DETAIL_CLASS_SYMBOL ffp : public sge::renderer::context::core
{
...
public:
  ...
  virtual void
  alpha_test_state(sge::renderer::state::ffp::alpha_test::const_optional_object_ref const &) = 0;

  virtual void
  clip_plane_state(sge::renderer::state::ffp::clip_plane::const_object_ref_vector const &) = 0;

  virtual void fog_state(sge::renderer::state::ffp::fog::const_optional_object_ref const &) = 0;

  virtual void
  lighting_state(sge::renderer::state::ffp::lighting::const_optional_object_ref const &) = 0;

  virtual void
  lights_state(sge::renderer::state::ffp::lighting::light::const_object_ref_vector const &) = 0;

  virtual void material_state(
      sge::renderer::state::ffp::lighting::material::const_optional_object_ref const &) = 0;

  virtual void misc_state(sge::renderer::state::ffp::misc::const_optional_object_ref const &) = 0;

  virtual void
  sampler_ffp_state(sge::renderer::state::ffp::sampler::const_object_ref_vector const &) = 0;

  virtual void transform(
      sge::renderer::state::ffp::transform::mode,
      sge::renderer::state::ffp::transform::const_optional_object_ref const &) = 0;
};
