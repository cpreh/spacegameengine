...
public:
  using buffer_type = sge::renderer::buffer::readable<Tag>;

  using buffer_ref = fcppt::reference<buffer_type const>;

  using lock_area = sge::image::box<Tag>;

  using const_view = sge::renderer::buffer::traits::const_view<Tag>;
  ...
  explicit const_scoped_lock(buffer_ref buffer);
  ...
  /**
	...
	*/
  SGE_RENDERER_DETAIL_SYMBOL
  const_scoped_lock(buffer_ref buffer, lock_area const &area);
  ...
  /**
	...
	*/
  [[nodiscard]] SGE_RENDERER_DETAIL_SYMBOL const_view value() const;
