...
sge::renderer::context::scoped_offscreen_target::scoped_offscreen_target(
    ...
    : context_(_context)
{
  context_.get().offscreen_target(sge::renderer::target::optional_offscreen_ref(_target));
}

sge::renderer::context::scoped_offscreen_target::~scoped_offscreen_target()
{
  context_.get().offscreen_target(sge::renderer::target::optional_offscreen_ref());
}
