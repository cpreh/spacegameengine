...
sge::renderer::display_mode::refresh_rate_value sge::renderer::display_mode::desired_fps(
    sge::renderer::display_mode::optional_object const &_opt_display_mode)
{
  // TODO(philipp): Remove this
  constexpr sge::renderer::display_mode::refresh_rate_value const default_value{60};
  ...
  return fcppt::optional::maybe(
      ...
      fcppt::const_(default_value),
      [](sge::renderer::display_mode::refresh_rate const _rate) { return _rate.get(); });
}
