...
sge::renderer::display_mode::parameters::parameters(
    ...
    : sge::renderer::display_mode::parameters::parameters(
          ...
          fcppt::optional::map(
              ...
              { return sge::renderer::display_mode::fullscreen{_mode}; }))
{
}
...
sge::renderer::display_mode::parameters::parameters(
    ...
    : vsync_(_vsync), fullscreen_(_fullscreen)
{
}

sge::renderer::display_mode::vsync sge::renderer::display_mode::parameters::vsync() const
{
  return vsync_;
}
