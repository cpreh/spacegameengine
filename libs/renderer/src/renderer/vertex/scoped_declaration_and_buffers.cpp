...
sge::renderer::vertex::scoped_declaration_and_buffers::scoped_declaration_and_buffers(
    ...
    : scoped_declaration_(_context, _vertex_declaration),
      scoped_buffers_(fcppt::algorithm::map<scoped_buffer_vector>(
          _vertex_buffers,
          [&_context](sge::renderer::vertex::const_buffer_ref const _ref)
          { return fcppt::make_unique_ptr<sge::renderer::vertex::scoped_buffer>(_context, _ref); }))
{
}

sge::renderer::vertex::scoped_declaration_and_buffers::~scoped_declaration_and_buffers() = default;
