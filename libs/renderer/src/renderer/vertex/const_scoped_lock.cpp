...
sge::renderer::vertex::const_scoped_lock::const_scoped_lock(
    sge::renderer::vertex::const_buffer_ref const _buffer, lock_area const &_area)
...
sge::renderer::vertex::const_scoped_lock::~const_scoped_lock() = default;

SGE_RENDERER_IMPL_BUFFER_INSTANTIATE_CONST_SCOPED_LOCK(sge::renderer::vertex::tag);
