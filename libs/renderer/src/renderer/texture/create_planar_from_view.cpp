...
sge::renderer::texture::planar_unique_ptr sge::renderer::texture::create_planar_from_view(
    ...
    sge::renderer::texture::emulate_srgb const _emulate_srgb)
{
  sge::renderer::texture::planar_unique_ptr tex(
      _renderer.get().create_planar_texture(sge::renderer::texture::planar_parameters(
          sge::image2d::view::size(_view),
          sge::renderer::texture::color_format(sge::image2d::view::format(_view), _emulate_srgb),
          _mipmap,
          _resource_flags,
