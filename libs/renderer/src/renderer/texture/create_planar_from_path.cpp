...
sge::renderer::texture::planar_unique_ptr sge::renderer::texture::create_planar_from_path(
...
{
  return sge::renderer::texture::create_planar_from_file(
      _renderer,
      *sge::image2d::load_exn(fcppt::make_ref(_system), _file),
      _mipmap,
      _flags,
      _emulate_srgb);
}
