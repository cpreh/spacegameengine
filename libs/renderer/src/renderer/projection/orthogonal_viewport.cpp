...
sge::renderer::optional_matrix4 sge::renderer::projection::orthogonal_viewport(
    sge::renderer::target::viewport const &_viewport,
    sge::renderer::projection::near const _near,
    sge::renderer::projection::far const _far)
{
  return sge::renderer::target::viewport_is_null(_viewport)
             ? sge::renderer::optional_matrix4()
             : sge::renderer::optional_matrix4(sge::renderer::projection::orthogonal(
                   sge::renderer::projection::rect(
                       fcppt::math::vector::null<sge::renderer::projection::rect::vector>(),
                       fcppt::math::dim::structure_cast<
                           sge::renderer::projection::rect::dim,
                           fcppt::cast::int_to_float_fun>(_viewport.get().size())),
                   _near,
                   _far));
}
