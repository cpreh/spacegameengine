  ...
  return std::ranges::contains(_formats, _format)
             ...
             : *fcppt::optional::to_exception(
                   fcppt::algorithm::find_if_opt(
                       _formats,
                       [_format](sge::renderer::vf::dynamic::color_format_vector::value_type const
                                     &_value) {
                         return sge::image::color::format_stride(_format) ==
                                sge::image::color::format_stride(_value);
                       }),
                   [_format]
                   {
                     return sge::renderer::exception{
                         FCPPT_TEXT("Unsupported vertex color ") +
                         sge::image::color::format_to_string(_format)};
                   });
}
