...
sge::renderer::vf::dynamic::extra_any const &sge::renderer::vf::dynamic::extra::type() const
{
  return this->type_;
}

sge::renderer::vf::dynamic::index sge::renderer::vf::dynamic::extra::index() const
{
  return this->index_;
}

bool sge::renderer::vf::dynamic::operator==(
    sge::renderer::vf::dynamic::extra const &_left, sge::renderer::vf::dynamic::extra const &_right)
{
