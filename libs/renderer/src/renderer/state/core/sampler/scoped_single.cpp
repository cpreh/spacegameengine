    ...
    : context_(_context), stage_(_stage)
{
  sge::renderer::state::core::sampler::single(
      context_, stage_, sge::renderer::state::core::sampler::const_optional_object_ref(_object));
}

sge::renderer::state::core::sampler::scoped_single::~scoped_single()
{
  sge::renderer::state::core::sampler::single(
      context_, stage_, sge::renderer::state::core::sampler::const_optional_object_ref());
}
