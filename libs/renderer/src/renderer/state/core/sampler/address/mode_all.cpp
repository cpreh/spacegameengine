...
{
  return {
      sge::renderer::state::core::sampler::address::mode_s(_mode),
      sge::renderer::state::core::sampler::address::mode_t(_mode),
      sge::renderer::state::core::sampler::address::mode_u(_mode)};
}
