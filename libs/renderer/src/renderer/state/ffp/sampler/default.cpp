...
sge::renderer::state::ffp::sampler::parameters sge::renderer::state::ffp::sampler::default_()
{
  sge::renderer::state::ffp::sampler::op const op(sge::renderer::state::ffp::sampler::default_op());

  return {
      sge::renderer::state::ffp::sampler::color_op(op),
      sge::renderer::state::ffp::sampler::alpha_op(op)};
}
