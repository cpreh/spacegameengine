...
sge::renderer::state::ffp::sampler::parameters sge::renderer::state::ffp::sampler::parameters_both(
    sge::renderer::state::ffp::sampler::op const &_op)
{
  return {
      sge::renderer::state::ffp::sampler::color_op(_op),
      sge::renderer::state::ffp::sampler::alpha_op(_op)};
}
