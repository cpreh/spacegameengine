...
sge::renderer::state::ffp::fog::enabled::enabled(
    ...
    : mode_(_mode), start_(_start), end_(_end), density_(_density), color_(std::move(_color))
{
}

sge::renderer::state::ffp::fog::mode sge::renderer::state::ffp::fog::enabled::mode() const
{
  return mode_;
}

sge::renderer::state::ffp::fog::start sge::renderer::state::ffp::fog::enabled::start() const
{
  return start_;
}

sge::renderer::state::ffp::fog::end sge::renderer::state::ffp::fog::enabled::end() const
{
  return end_;
}

sge::renderer::state::ffp::fog::density sge::renderer::state::ffp::fog::enabled::density() const
{
  return density_;
}

sge::renderer::state::ffp::fog::color sge::renderer::state::ffp::fog::enabled::color() const
{
  return color_;
}
