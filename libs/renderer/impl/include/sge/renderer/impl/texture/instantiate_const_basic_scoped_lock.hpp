...
#include <sge/renderer/impl/texture/const_basic_scoped_lock_impl.hpp> // IWYU pragma: keep

#define SGE_RENDERER_IMPL_TEXTURE_INSTANTIATE_CONST_BASIC_SCOPED_LOCK(tag) \
  template class SGE_CORE_IMPL_EXPORT_CLASS_INSTANTIATION \
      sge::renderer::texture::const_basic_scoped_lock<tag>
