...
sge::model::md3::impl::transformed_vertex::transformed_vertex(
    ...
    : pos_(
          ...
          fcppt::cast::int_to_float<sge::model::md3::scalar>(_vertex.x()) *
              sge::model::md3::impl::xyz_scale(),
          fcppt::cast::int_to_float<sge::model::md3::scalar>(_vertex.y()) *
              sge::model::md3::impl::xyz_scale(),
          fcppt::cast::int_to_float<sge::model::md3::scalar>(_vertex.z()) *
              sge::model::md3::impl::xyz_scale()),
      normal_(sge::model::md3::impl::convert_normal(_vertex.normal()))
{
}

sge::model::md3::impl::vec3 const &sge::model::md3::impl::transformed_vertex::pos() const
{
  return pos_;
}

sge::model::md3::impl::vec3 const &sge::model::md3::impl::transformed_vertex::normal() const
{
  return normal_;
}
