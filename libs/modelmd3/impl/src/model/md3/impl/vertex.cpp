...
sge::model::md3::impl::vertex::vertex(
    ...
    : x_(sge::model::md3::impl::read_s16(_stream)),
      y_(sge::model::md3::impl::read_s16(_stream)),
      z_(sge::model::md3::impl::read_s16(_stream)),
      normal_(sge::model::md3::impl::read_s16(_stream))
{
  if (_flags & sge::model::md3::load_flags::switch_yz)
  {
    ...
    //
    // (-x,z,y)
    x_ = fcppt::cast::size<sge::model::md3::impl::s16>(-x_);

    std::swap(y_, z_);
  }
}

sge::model::md3::impl::s16 sge::model::md3::impl::vertex::x() const { return x_; }

sge::model::md3::impl::s16 sge::model::md3::impl::vertex::y() const { return y_; }

sge::model::md3::impl::s16 sge::model::md3::impl::vertex::z() const { return z_; }

sge::model::md3::impl::s16 sge::model::md3::impl::vertex::normal() const { return normal_; }
