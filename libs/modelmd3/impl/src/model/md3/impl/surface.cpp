      ...
      transformed_vertices_()
{
  ...
  {
    throw sge::model::md3::exception(FCPPT_TEXT("Invalid md3 surface!"));
  }
  ...
  sge::model::md3::impl::s32 const frames(sge::model::md3::impl::read_s32(_stream));

  if (frames != _num_frames_head.get())
  {
    throw sge::model::md3::exception(FCPPT_TEXT("num_frames mismatch in md3::impl::surface!"));
  }

  sge::model::md3::impl::s32 const num_shaders(sge::model::md3::impl::read_s32(_stream));

  sge::model::md3::impl::s32 const num_verts(sge::model::md3::impl::read_s32(_stream));

  sge::model::md3::impl::s32 const num_triangles(sge::model::md3::impl::read_s32(_stream));

  sge::model::md3::impl::s32 const ofs_triangles(sge::model::md3::impl::read_s32(_stream));

  sge::model::md3::impl::s32 const ofs_shaders(sge::model::md3::impl::read_s32(_stream));

  sge::model::md3::impl::s32 const ofs_st(sge::model::md3::impl::read_s32(_stream));

  sge::model::md3::impl::s32 const ofs_xyznormal(sge::model::md3::impl::read_s32(_stream));

  sge::model::md3::impl::s32 const ofs_end(sge::model::md3::impl::read_s32(_stream));

  _stream.seekg(start + ofs_triangles, std::ios_base::beg);
  ...
  _stream.seekg(start + ofs_shaders, std::ios_base::beg);
  ...
  _stream.seekg(start + ofs_st, std::ios_base::beg);
  ...
  _stream.seekg(start + ofs_xyznormal, std::ios_base::beg);
  ...
  _stream.seekg(start + ofs_end, std::ios_base::beg);
}

sge::model::md3::string const &sge::model::md3::impl::surface::name() const { return name_; }

sge::model::md3::impl::shader_vector const &sge::model::md3::impl::surface::shaders() const
{
  return shaders_;
}

sge::model::md3::impl::triangle_vector const &sge::model::md3::impl::surface::triangles() const
{
  return triangles_;
}

sge::model::md3::impl::texpos_vector const &sge::model::md3::impl::surface::texpos() const
{
  return texpos_;
}
