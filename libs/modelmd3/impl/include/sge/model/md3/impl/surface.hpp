...
{
public:
  FCPPT_DECLARE_STRONG_TYPEDEF(sge::model::md3::impl::s32, num_frames);

  surface(std::istream &, sge::model::md3::load_flags_field, num_frames);

  [[nodiscard]] sge::model::md3::string const &name() const;

  [[nodiscard]] sge::model::md3::impl::shader_vector const &shaders() const;

  [[nodiscard]] sge::model::md3::impl::triangle_vector const &triangles() const;

  [[nodiscard]] sge::model::md3::impl::texpos_vector const &texpos() const;

  [[nodiscard]] sge::model::md3::impl::transformed_vertex_vector const &
