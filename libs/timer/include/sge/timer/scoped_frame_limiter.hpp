...
{
  FCPPT_NONMOVABLE(scoped_frame_limiter);

public:
  using clock_type = sge::timer::clocks::standard;

  using ticks_per_second = unsigned;
  ...
  explicit scoped_frame_limiter(ticks_per_second ticks);
