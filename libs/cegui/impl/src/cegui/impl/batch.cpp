...
sge::cegui::impl::batch::batch(batch &&) noexcept = default;

sge::cegui::impl::batch &sge::cegui::impl::batch::operator=(batch &&) noexcept = default;

sge::cegui::impl::batch::~batch() = default;

sge::renderer::texture::planar &sge::cegui::impl::batch::texture() const { return texture_.get(); }

sge::renderer::vertex::buffer &sge::cegui::impl::batch::vertex_buffer() const
{
  return *vertex_buffer_;
}

sge::cegui::impl::clip sge::cegui::impl::batch::clip() const { return clip_; }
