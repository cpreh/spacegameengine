...
sge::cegui::impl::scoped_system::scoped_system(
    ...
    fcppt::reference<sge::cegui::impl::image_codec> const _image_codec,
    fcppt::reference<sge::cegui::impl::resource_provider> const _resource_provider)
{
  CEGUI::System::create(
      _renderer.get(),
      // Resource provider
...
sge::cegui::impl::scoped_system::~scoped_system() { CEGUI::System::destroy(); }
