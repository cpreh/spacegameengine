...
class image_codec : public CEGUI::ImageCodec
{
  FCPPT_NONMOVABLE(image_codec);

public:
  explicit image_codec(sge::image2d::system_ref);

  ~image_codec() override;

private:
  [[nodiscard]] CEGUI::Texture *load(CEGUI::RawDataContainer const &, CEGUI::Texture *) override;
