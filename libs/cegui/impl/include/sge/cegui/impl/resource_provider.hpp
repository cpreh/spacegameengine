...
class resource_provider : public CEGUI::ResourceProvider
{
...
private:
  ...
  void unloadRawDataContainer(CEGUI::RawDataContainer &) override;

  [[nodiscard]] size_t getResourceGroupFileNames(
      std::vector<CEGUI::String> &out_vec, // NOLINT(google-runtime-references)
      CEGUI::String const &file_pattern,
      CEGUI::String const &resource_group) override;
