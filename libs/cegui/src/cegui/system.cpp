...
sge::cegui::system::system(
    ...
    : impl_(fcppt::make_unique_ptr<sge::cegui::detail::system_impl>(
          _log_context,
          _load_context,
          _renderer,
          _image_system,
...
sge::cegui::system::~system() = default;

void sge::cegui::system::update(sge::cegui::duration const &_duration) { impl_->update(_duration); }

void sge::cegui::system::render(sge::renderer::context::ffp &_context) { impl_->render(_context); }
...
CEGUI::GUIContext &sge::cegui::system::gui_context() { return impl_->gui_context(); }

CEGUI::GUIContext const &sge::cegui::system::gui_context() const { return impl_->gui_context(); }
