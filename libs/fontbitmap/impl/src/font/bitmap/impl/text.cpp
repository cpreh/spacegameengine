...
)
{
	...
	this->iterate(
		...
		{
			sge::font::bitmap::impl::char_metric const &char_metric(
				_position.metric()
			);

			sge::font::bitmap::impl::const_view const source_view(
				char_metric.view()
			);
...
sge::font::rect
sge::font::bitmap::impl::text::rect() const
{
	return
		rep_.rect();
}
...
sge::font::dim
sge::font::bitmap::impl::text::logical_size() const
{
	return
		this->rect().size();
}
...
sge::font::rect
sge::font::bitmap::impl::text::cursor_rect(
...
sge::font::bitmap::impl::text::pos_to_index(
...
>
void
sge::font::bitmap::impl::text::iterate(
...
) const
{
	...
	for(
		sge::font::bitmap::impl::line const &line
		:
		rep_.lines()
	)
	{
