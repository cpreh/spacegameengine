...
sge::parse::ini::typed::entry_type_error::entry_type_error(
...
bool sge::parse::ini::typed::entry_type_error::operator==(
    sge::parse::ini::typed::entry_type_error const &) const noexcept = default;
