...
class SGE_CORE_DETAIL_CLASS_SYMBOL frame : public sge::rucksack::widget::base
{
  FCPPT_NONMOVABLE(frame);

public:
  SGE_RUCKSACK_DETAIL_SYMBOL
  frame(sge::rucksack::widget::reference, sge::rucksack::padding);
  ...
  [[nodiscard]] SGE_RUCKSACK_DETAIL_SYMBOL sge::rucksack::padding padding() const;

private:
  [[nodiscard]] sge::rucksack::vector shifted_position() const;

  [[nodiscard]] sge::rucksack::dim extra_size() const;
