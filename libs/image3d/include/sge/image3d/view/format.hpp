...
sge::image::color::format format(sge::image3d::view::object const &);

SGE_IMAGE3D_DETAIL_SYMBOL
sge::image::color::format format(sge::image3d::view::const_object const &);

}

SGE_IMAGE_VIEW_DECLARE_FORMAT(sge::image3d::tag);
