...
sge::image3d::algorithm::clone(sge::image3d::view::const_object const &_view)
{
  return sge::image::algorithm::clone<sge::image3d::tag>(_view);
}

SGE_IMAGE_IMPL_ALGORITHM_INSTANTIATE_CLONE(sge::image3d::tag);
