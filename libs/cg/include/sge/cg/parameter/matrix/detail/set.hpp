...
#include <sge/cg/parameter/matrix/detail/set_double.hpp> // IWYU pragma: keep
#include <sge/cg/parameter/matrix/detail/set_float.hpp> // IWYU pragma: keep
#include <sge/cg/parameter/matrix/detail/set_int.hpp> // IWYU pragma: keep
