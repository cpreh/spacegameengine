...
sge::cg::context::object const &sge::cg::program::from_string_parameters::context() const
{
  return context_.get();
}

sge::cg::program::source_type sge::cg::program::from_string_parameters::source_type() const
{
  return source_type_;
}

sge::cg::profile::object const &sge::cg::program::from_string_parameters::profile() const
{
  return profile_.get();
}

sge::cg::program::source const &sge::cg::program::from_string_parameters::source() const
{
  return source_;
}
