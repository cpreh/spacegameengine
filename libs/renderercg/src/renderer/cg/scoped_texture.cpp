...
sge::renderer::cg::scoped_texture::scoped_texture(
    ...
    : context_(_context), texture_(_texture), stage_(context_.get().set_cg_texture(texture_))
{
}

sge::renderer::cg::scoped_texture::~scoped_texture()
{
  context_.get().unset_cg_texture(texture_.get());
}

sge::renderer::texture::stage sge::renderer::cg::scoped_texture::stage() const { return stage_; }
