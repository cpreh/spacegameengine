...
fcppt::reference<Object> find_object_exn_impl(
    fcppt::reference<Object> const _input_object, sge::parse::json::path const &_path)
{
  return fcppt::optional::to_exception(
      sge::parse::json::find_object(_input_object, _path),
      [&_path]
      {
        return sge::parse::exception(
            FCPPT_TEXT("Couldn't navigate to \"") +
            sge::parse::json::detail::to_fcppt_string(sge::parse::json::path_to_string(_path)) +
...
fcppt::reference<sge::parse::json::object> sge::parse::json::find_object_exn(
    fcppt::reference<sge::parse::json::object> const _input_object,
    sge::parse::json::path const &_path)
{
  return find_object_exn_impl(_input_object, _path);
}

fcppt::reference<sge::parse::json::object const> sge::parse::json::find_object_exn(
