...
find_object(fcppt::reference<sge::parse::json::object>, sge::parse::json::path const &);

SGE_PARSE_JSON_DETAIL_SYMBOL
sge::parse::json::const_optional_object_ref
find_object(fcppt::reference<sge::parse::json::object const>, sge::parse::json::path const &);
