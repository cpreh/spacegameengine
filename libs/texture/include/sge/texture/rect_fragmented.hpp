...
class SGE_CORE_DETAIL_CLASS_SYMBOL rect_fragmented : public sge::texture::fragmented
{
  FCPPT_NONMOVABLE(rect_fragmented);
...
private:
  ...
  void return_fragment(sge::texture::part const &) override;

  [[nodiscard]] sge::renderer::texture::planar &texture() override;

  [[nodiscard]] sge::renderer::texture::planar const &texture() const override;
