...
#define SGE_DEFINE_COLOR_A(name, r, g, b, a) \
  sge::image::color::rgba8 sge::image::color::predef::name() \
  { \
    typedef sge::image::color::rgba8 color_type; \
\
    typedef color_type::format::channel_type value_type; \
\
    return color_type{(sge::image::color::init::red() = fcppt::literal<value_type>(r))( \
...
#define SGE_DEFINE_COLOR(name, r, g, b) SGE_DEFINE_COLOR_A(name, r, g, b, 255)
