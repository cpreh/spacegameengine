...
#include <sge/image/color/sbgr8_format.hpp> // NOLINT(misc-include-cleaner)
#include <sge/image/color/sbgra8_format.hpp> // NOLINT(misc-include-cleaner)
...
#include <sge/image/color/traits/static_formats.hpp> // NOLINT(misc-include-cleaner)
