...
struct tag_of<sge::image::color::impl::dynamic::format::object<Space, BaseType, NumChannels>>
{
  using type = mizuiro::color::format::homogenous_dynamic_ns::tag<
      sge::image::color::impl::dynamic::format::object<Space, BaseType, NumChannels>>;
};
