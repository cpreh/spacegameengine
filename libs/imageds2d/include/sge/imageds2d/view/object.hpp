...
#ifndef SGE_IMAGEDS2D_VIEW_OBJECT_HPP_INCLUDED
#define SGE_IMAGEDS2D_VIEW_OBJECT_HPP_INCLUDED
...
#include <sge/imageds2d/view/object_fwd.hpp> // IWYU pragma: export

SGE_IMAGE_VIEW_DECLARE_OBJECT(sge::imageds2d::tag);
