...
class box_container : public sge::gui::widget::container
{
  FCPPT_NONMOVABLE(box_container);
...
public:
  ...
  SGE_GUI_DETAIL_SYMBOL
  ~box_container() override;

  SGE_GUI_DETAIL_SYMBOL
  void push_front(sge::gui::widget::reference_alignment_pair const &);

  SGE_GUI_DETAIL_SYMBOL
  void pop_front();

  SGE_GUI_DETAIL_SYMBOL
  void push_back(sge::gui::widget::reference_alignment_pair const &);
  ...
  SGE_GUI_DETAIL_SYMBOL
  void replace(
      sge::rucksack::widget::box::size_type, sge::gui::widget::reference_alignment_pair const &);

  SGE_GUI_DETAIL_SYMBOL
  void clear();

  [[nodiscard]] sge::rucksack::widget::box &box_layout();
