...
#include <sge/gui/widget/reference_name_pair_fwd.hpp> // IWYU pragma: keep
...
public:
  ...
  reference_name_pair(sge::gui::widget::reference, sge::font::string &&);

  [[nodiscard]] sge::gui::widget::reference reference() const;
