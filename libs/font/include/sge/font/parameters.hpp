...
public:
  ...
  SGE_FONT_DETAIL_SYMBOL
  sge::font::parameters &dpi(sge::font::dpi const &);

  SGE_FONT_DETAIL_SYMBOL
  sge::font::parameters &ttf_size(sge::font::ttf_size);

  SGE_FONT_DETAIL_SYMBOL
  sge::font::parameters &family(fcppt::string const &);

  SGE_FONT_DETAIL_SYMBOL
  sge::font::parameters &weight(sge::font::weight::unit);

  SGE_FONT_DETAIL_SYMBOL
  sge::font::parameters &italic();

  [[nodiscard]] SGE_FONT_DETAIL_SYMBOL sge::font::optional_dpi const &dpi() const;

  [[nodiscard]] SGE_FONT_DETAIL_SYMBOL sge::font::optional_ttf_size const &ttf_size() const;

  [[nodiscard]] SGE_FONT_DETAIL_SYMBOL sge::font::optional_family const &family() const;

  [[nodiscard]] SGE_FONT_DETAIL_SYMBOL sge::font::weight::optional_unit const &weight() const;

  [[nodiscard]] SGE_FONT_DETAIL_SYMBOL bool italic() const;
