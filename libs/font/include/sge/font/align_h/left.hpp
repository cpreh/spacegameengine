...
#include <sge/font/align_h/left_fwd.hpp> // IWYU pragma: keep
...
public:
  ...
  SGE_FONT_DETAIL_SYMBOL
  explicit left(sge::font::align_h::max_width);

  [[nodiscard]] SGE_FONT_DETAIL_SYMBOL sge::font::align_h::optional_max_width max_width() const;
