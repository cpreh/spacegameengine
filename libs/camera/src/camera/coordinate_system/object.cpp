...
sge::camera::coordinate_system::object::object(
    ...
    : right_(_right), up_(_up), forward_(_forward), position_(_position)
{
}

sge::camera::coordinate_system::right const &sge::camera::coordinate_system::object::right() const
{
  return right_;
}

void sge::camera::coordinate_system::object::right(
    sge::camera::coordinate_system::right const &_right)
{
  right_ = _right;
}

sge::camera::coordinate_system::up const &sge::camera::coordinate_system::object::up() const
{
  return up_;
}

void sge::camera::coordinate_system::object::up(sge::camera::coordinate_system::up const &_up)
{
  up_ = _up;
}
...
void sge::camera::coordinate_system::object::forward(
    sge::camera::coordinate_system::forward const &_forward)
{
  forward_ = _forward;
}
...
void sge::camera::coordinate_system::object::position(
    sge::camera::coordinate_system::position const &_position)
{
  position_ = _position;
}
