...
sge::camera::matrix_conversion::world_matrix_to_coordinate_system(sge::renderer::matrix4 const &_m)
{
  sge::renderer::matrix4 const inverted(fcppt::math::matrix::inverse(_m));
  ...
  return sge::camera::coordinate_system::object(
      sge::camera::coordinate_system::right(
          fcppt::math::vector::narrow_cast<sge::renderer::vector3>(
              fcppt::math::matrix::at_r<0>(_m))),
      sge::camera::coordinate_system::up(fcppt::math::vector::narrow_cast<sge::renderer::vector3>(
          fcppt::math::matrix::at_r<1>(_m))),
      sge::camera::coordinate_system::forward(
          fcppt::math::vector::narrow_cast<sge::renderer::vector3>(
              fcppt::math::matrix::at_r<2>(_m))),
      sge::camera::coordinate_system::position(sge::renderer::vector3(
          -fcppt::math::matrix::at_r_c<0, 3>(inverted),
          -fcppt::math::matrix::at_r_c<1, 3>(inverted),
          -fcppt::math::matrix::at_r_c<2, 3>(inverted))));
}
