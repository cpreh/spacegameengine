...
sge::camera::spherical::coordinate_system::object sge::camera::spherical::coordinate_system::null()
{
  return sge::camera::spherical::coordinate_system::object(
      sge::camera::spherical::coordinate_system::azimuth(0.0F),
      sge::camera::spherical::coordinate_system::inclination(0.0F),
      sge::camera::spherical::coordinate_system::radius(0.0F));
}
