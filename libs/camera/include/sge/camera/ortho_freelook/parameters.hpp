...
public:
  ...
  parameters(sge::renderer::projection::near, sge::renderer::projection::far);

  SGE_CAMERA_DETAIL_SYMBOL
  parameters &zoom_speed(sge::camera::ortho_freelook::zoom_speed);

  [[nodiscard]] SGE_CAMERA_DETAIL_SYMBOL sge::camera::ortho_freelook::zoom_speed zoom_speed() const;

  SGE_CAMERA_DETAIL_SYMBOL
  parameters &action_mapping(sge::camera::ortho_freelook::action::mapping const &);

  [[nodiscard]] SGE_CAMERA_DETAIL_SYMBOL sge::camera::ortho_freelook::action::mapping const &
  action_mapping() const;

  SGE_CAMERA_DETAIL_SYMBOL
  parameters &pan_speed(sge::camera::ortho_freelook::pan_speed);

  [[nodiscard]] SGE_CAMERA_DETAIL_SYMBOL sge::camera::ortho_freelook::pan_speed pan_speed() const;

  SGE_CAMERA_DETAIL_SYMBOL
  parameters &projection_rectangle(sge::renderer::projection::rect const &);
  ...
  [[nodiscard]] SGE_CAMERA_DETAIL_SYMBOL sge::renderer::projection::near near() const;

  [[nodiscard]] SGE_CAMERA_DETAIL_SYMBOL sge::renderer::projection::far far() const;
