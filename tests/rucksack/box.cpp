...
TEST_CASE("rucksack::box", "[sge]")
{
  sge::rucksack::widget::dummy child1{sge::rucksack::axis_policy2{
  ...
  sge::rucksack::widget::box box1{
      ...
      sge::rucksack::widget::reference_alignment_container{
          sge::rucksack::widget::reference_alignment{
              sge::rucksack::widget::reference{child1}, sge::rucksack::alignment::center}}};

  box1.size(sge::rucksack::dim{
  ...
  sge::rucksack::widget::dummy child2{sge::rucksack::axis_policy2{
      sge::rucksack::axis_policy{sge::rucksack::preferred_size{
          10 // NOLINT(cppcoreguidelines-avoid-magic-numbers,readability-magic-numbers)
      }},
      sge::rucksack::axis_policy{sge::rucksack::preferred_size{
  ...
  box1.push_back_child(
      fcppt::reference_to_base<sge::rucksack::widget::base>(fcppt::make_ref(child2)),
...
TEST_CASE("rucksack::box in box", "[sge]")
{
  ...
  sge::rucksack::widget::dummy child_x_2{sge::rucksack::axis_policy2{
      sge::rucksack::axis_policy{sge::rucksack::preferred_size{
  ...
  sge::rucksack::widget::box box1{
      ...
      sge::rucksack::widget::reference_alignment_container{
          sge::rucksack::widget::reference_alignment{
              sge::rucksack::widget::reference{child_x_1}, sge::rucksack::alignment::center},
          sge::rucksack::widget::reference_alignment{
              sge::rucksack::widget::reference{child_x_2}, sge::rucksack::alignment::left_or_top}}};

  sge::rucksack::widget::dummy child_y_1{sge::rucksack::axis_policy2{
      sge::rucksack::axis_policy{sge::rucksack::minimum_size{0}},
      sge::rucksack::axis_policy{sge::rucksack::preferred_size{
          10 // NOLINT(cppcoreguidelines-avoid-magic-numbers,readability-magic-numbers)
      }}}};

  sge::rucksack::widget::dummy child_y_2{sge::rucksack::axis_policy2{
      sge::rucksack::axis_policy{sge::rucksack::minimum_size{0}},
      sge::rucksack::axis_policy{sge::rucksack::preferred_size{0}}}};
  ...
  sge::rucksack::widget::box box2{
      ...
      sge::rucksack::widget::reference_alignment_container{
          sge::rucksack::widget::reference_alignment{
              sge::rucksack::widget::reference{box1}, sge::rucksack::alignment::center},
          sge::rucksack::widget::reference_alignment{
              sge::rucksack::widget::reference{child_y_1}, sge::rucksack::alignment::center},
          sge::rucksack::widget::reference_alignment{
              sge::rucksack::widget::reference{child_y_2}, sge::rucksack::alignment::center}}};

  box2.size(sge::rucksack::dim{
      100, // NOLINT(cppcoreguidelines-avoid-magic-numbers,readability-magic-numbers)
  ...
  CHECK(box1.position() == sge::rucksack::vector{0, 0});

  box1.push_back_child(
      fcppt::reference_to_base<sge::rucksack::widget::base>(fcppt::make_ref(child_x_2)),
