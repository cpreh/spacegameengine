...
public:
	...
	result_type
	operator()(
		sge::log::detail::inner_context_node const &
	) const;

	result_type
	operator()(
		sge::log::detail::outer_context_node const &
	) const;
private:
...
sge::log::inner_node_name::inner_node_name(
	string const &name_
)
:
	name_(name_)
...
sge::log::inner_node_name::result_type
sge::log::inner_node_name::operator()(
...
compare::result_type
compare::operator()(
	sge::log::detail::inner_context_node const &inner_node_
) const
{
