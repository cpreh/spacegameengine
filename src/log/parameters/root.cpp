...
#include <sge/log/enabled_levels.hpp>

sge::log::parameters::root::root(
	ostream &sink_
)
:
	sink_(sink_),
...
sge::log::parameters::root::prefix(
...
sge::log::parameters::root
sge::log::parameters::root::enabled(
...
sge::log::parameters::root
sge::log::parameters::root::context(
...
sge::log::parameters::root::create() const
{
	return
		all(
			sink_
