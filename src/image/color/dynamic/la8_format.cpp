...
sge::image::color::dynamic::c8_2_format::channel_array const channels
{{
	sge::image::color::dynamic::available_channels::luminance,
...
sge::image::color::dynamic::la8_format(
	channels,
	sge::image::color::dynamic::available_layouts::gray,
