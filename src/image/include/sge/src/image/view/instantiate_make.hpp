...
#ifndef SGE_SRC_IMAGE_VIEW_INSTANTIATE_MAKE_HPP_INCLUDED
#define SGE_SRC_IMAGE_VIEW_INSTANTIATE_MAKE_HPP_INCLUDED
...
#define SGE_SRC_IMAGE_VIEW_INSTANTIATE_MAKE(\
	tag\
)\
template \
FCPPT_EXPORT_SYMBOL \
