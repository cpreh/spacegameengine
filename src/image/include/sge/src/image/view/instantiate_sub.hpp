...
#ifndef SGE_SRC_IMAGE_VIEW_INSTANTIATE_SUB_HPP_INCLUDED
#define SGE_SRC_IMAGE_VIEW_INSTANTIATE_SUB_HPP_INCLUDED
...
#define SGE_SRC_IMAGE_VIEW_INSTANTIATE_SUB_BASE(\
	tag,\
	view_type\
)\
template \
...
SGE_SRC_IMAGE_VIEW_INSTANTIATE_CONST_NONCONST(\
	tag,\
	SGE_SRC_IMAGE_VIEW_INSTANTIATE_SUB_BASE\
)
