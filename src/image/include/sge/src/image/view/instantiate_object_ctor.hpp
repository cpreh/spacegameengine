...
#ifndef SGE_SRC_IMAGE_VIEW_INSTANTIATE_OBJECT_CTOR_HPP_INCLUDED
#define SGE_SRC_IMAGE_VIEW_INSTANTIATE_OBJECT_CTOR_HPP_INCLUDED
...
#define SGE_SRC_IMAGE_VIEW_INSTANTIATE_OBJECT_CTOR(\
	format_arg,\
	args\
) \
template \
