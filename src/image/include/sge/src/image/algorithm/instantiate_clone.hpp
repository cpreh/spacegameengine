...
#ifndef SGE_SRC_IMAGE_ALGORITHM_INSTANTIATE_CLONE_HPP_INCLUDED
#define SGE_SRC_IMAGE_ALGORITHM_INSTANTIATE_CLONE_HPP_INCLUDED
...
#define SGE_SRC_IMAGE_ALGORITHM_INSTANTIATE_CLONE(\
	tag\
)\
template \
