...
>
{
	typedef sge::image::dynamic::color::c8_1_format type;
};
...
>
{
	typedef sge::image::dynamic::color::c32f_1_format type;
};
...
>
{
	typedef sge::image::dynamic::color::c8_2_format type;
};
...
>
{
	typedef sge::image::dynamic::color::c8_3_format type;
};
...
>
{
	typedef sge::image::dynamic::color::c32f_4_format type;
};
