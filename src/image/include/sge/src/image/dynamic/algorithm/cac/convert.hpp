...
#ifndef SGE_SRC_IMAGE_DYNAMIC_ALGORITHM_CAC_CONVERT_HPP_INCLUDED
#define SGE_SRC_IMAGE_DYNAMIC_ALGORITHM_CAC_CONVERT_HPP_INCLUDED

#include <sge/src/image/dynamic/algorithm/cac/choose.hpp>
#include <sge/src/image/dynamic/algorithm/cac/convert_visitor.hpp>
