...
sge::md3::scalar const
xyz_scale(
	static_cast<sge::md3::scalar>(1)
	/ static_cast<sge::md3::scalar>(64)
);
...
sge::md3::object_impl::object_impl(
	std::istream &is,
...
sge::md3::index_sequence const
sge::md3::object_impl::indices(
...
) const
{
	...
	sge::md3::object_impl::surface_vector::const_reference surf(
		surface_by_name(
			_name
		)
	);
	...
	for(	
		sge::md3::object_impl::surface::triangle_vector::const_iterator triangle_it(
	...
	{
		for(
			sge::md3::object_impl::surface::triangle::index_array::const_iterator index_it(
...
sge::md3::vertex_sequence const
sge::md3::object_impl::vertices(
...
fcppt::optional<sge::md3::texcoord_sequence> const
sge::md3::object_impl::texcoords(
	fcppt::string const &name) const
{
...
fcppt::optional<sge::md3::normal_sequence> const
sge::md3::object_impl::normals(
	fcppt::string const &name) const
{
...
sge::md3::part_name_sequence const
sge::md3::object_impl::part_names() const
{
...
bool sge::md3::object_impl::read_and_check_id3p(std::istream& is)
{
...
template<
	sge::md3::object_impl::string::size_type Max
>
inline sge::md3::object_impl::string const
sge::md3::object_impl::read_string(
	std::istream &_stream
)
{
...
inline
sge::md3::object_impl::vec3 sge::md3::object_impl::convert_normal(
	s16 const _normal
)
{
	scalar const
...
sge::md3::object_impl::surface_vector::const_reference
sge::md3::object_impl::surface_by_name(
	fcppt::string const &_name
) const
{
	for(
...
inline sge::md3::object_impl::vec3
sge::md3::object_impl::read_vec3(
	std::istream &is)
{
	return vec3(
...
inline sge::md3::object_impl::frame::frame(
	std::istream &is)
:
...
inline sge::md3::object_impl::tag::tag(std::istream& is)
:
...
inline sge::md3::object_impl::surface::surface(std::istream& is, md3::load_flags::type const lf, const s32 num_frames_head)
{
...
sge::md3::object_impl::surface::shader::shader(
	std::istream &is)
:
	name(read_string<max_qpath>(is)),
...
sge::md3::object_impl::surface::triangle::triangle(
	std::istream& is)
{
...
sge::md3::object_impl::surface::texcoord::texcoord(
	std::istream& is)
:
	tex(
		fcppt::io::read<scalar>(is, endian),
...
sge::md3::object_impl::surface::vertex::vertex(
	std::istream& is,
	md3::load_flags::type const lf)
:
...
sge::md3::object_impl::surface::transformed_vertex::transformed_vertex(
	vertex const &v)
:
	pos(
