...
#ifndef SGE_SRC_RENDERER_TEXTURE_INSTANTIATE_CONST_BASIC_SCOPED_LOCK_HPP_INCLUDED
#define SGE_SRC_RENDERER_TEXTURE_INSTANTIATE_CONST_BASIC_SCOPED_LOCK_HPP_INCLUDED
