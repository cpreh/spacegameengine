...
//	key_vector_[DIK_ABNT_C2] = input::keyboard::key_code::key_ABNT_C2;
	...
	key_vector_[DIK_APPS] = input::keyboard::key_code::apps;
	key_vector_[DIK_AT] = input::keyboard::key_code::at;
	key_vector_[DIK_AX] = input::keyboard::key_code::ax;
	key_vector_[DIK_B] = input::keyboard::key_code::b;
	key_vector_[DIK_BACK] = input::keyboard::key_code::backspace;
	key_vector_[DIK_BACKSLASH] = input::keyboard::key_code::backslash;
	key_vector_[DIK_C] = input::keyboard::key_code::c;
//	key_vector_[DIK_CALCULATOR] = input::keyboard::key_code::key_CALC;
	key_vector_[DIK_CAPITAL] = input::keyboard::key_code::capital;
	key_vector_[DIK_COLON] = input::keyboard::key_code::colon;
	key_vector_[DIK_COMMA] = input::keyboard::key_code::comma;
	key_vector_[DIK_CONVERT] = input::keyboard::key_code::convert;
	key_vector_[DIK_D] = input::keyboard::key_code::d;
	key_vector_[DIK_DECIMAL] = input::keyboard::key_code::decimal;
	...
	key_vector_[DIK_GRAVE] = input::keyboard::key_code::grave;
	...
	key_vector_[DIK_LBRACKET] = input::keyboard::key_code::left_bracket;
	key_vector_[DIK_LCONTROL] = input::keyboard::key_code::left_control;
	key_vector_[DIK_LEFT] = input::keyboard::key_code::left;
	key_vector_[DIK_LMENU] = input::keyboard::key_code::left_alt;
	key_vector_[DIK_LSHIFT] = input::keyboard::key_code::left_shift;
	key_vector_[DIK_LWIN] = input::keyboard::key_code::left_win;
...
//	key_vector_[DIK_NEXT] = input::keyboard::key_code::next;
	key_vector_[DIK_NOCONVERT] = input::keyboard::key_code::noconvert;
	key_vector_[DIK_NUMLOCK] = input::keyboard::key_code::num_lock;
	key_vector_[DIK_NUMPAD0] = input::keyboard::key_code::num_0;
	key_vector_[DIK_NUMPAD1] = input::keyboard::key_code::num_1;
	key_vector_[DIK_NUMPAD2] = input::keyboard::key_code::num_2;
	key_vector_[DIK_NUMPAD3] = input::keyboard::key_code::num_3;
	key_vector_[DIK_NUMPAD4] = input::keyboard::key_code::num_4;
	key_vector_[DIK_NUMPAD5] = input::keyboard::key_code::num_5;
	key_vector_[DIK_NUMPAD6] = input::keyboard::key_code::num_6;
	key_vector_[DIK_NUMPAD7] = input::keyboard::key_code::num_7;
	key_vector_[DIK_NUMPAD8] = input::keyboard::key_code::num_8;
	key_vector_[DIK_NUMPAD9] = input::keyboard::key_code::num_9;
	key_vector_[DIK_NUMPADEQUALS] = input::keyboard::key_code::num_equals;
	...
	key_vector_[DIK_POWER] = input::keyboard::key_code::power;
//	key_vector_[DIK_PRIOR] = input::keyboard::key_code::key_prior;
	...
	key_vector_[DIK_RBRACKET] =  input::keyboard::key_code::right_bracket;
	key_vector_[DIK_RCONTROL] = input::keyboard::key_code::right_control;
	key_vector_[DIK_RETURN] = input::keyboard::key_code::return_;
	key_vector_[DIK_RIGHT] = input::keyboard::key_code::right;
	key_vector_[DIK_RMENU] = input::keyboard::key_code::right_alt;
	key_vector_[DIK_RSHIFT] = input::keyboard::key_code::right_shift;
	key_vector_[DIK_RWIN] = input::keyboard::key_code::right_win;
	...
	key_vector_[DIK_SLEEP] = input::keyboard::key_code::sleep;
	key_vector_[DIK_SPACE] = input::keyboard::key_code::space;
	key_vector_[DIK_STOP] = input::keyboard::key_code::stop;
	key_vector_[DIK_SUBTRACT] = input::keyboard::key_code::subtract;
	key_vector_[DIK_SYSRQ] = input::keyboard::key_code::sysrq;
	...
	key_vector_[DIK_UNLABELED] = input::keyboard::key_code::unlabeled;
