...
#ifndef SGE_D3D9_CONVERSION_HPP_INCLUDED
#define SGE_D3D9_CONVERSION_HPP_INCLUDED
...
template<> D3DPRIMITIVETYPE convert_cast (const indexed_primitive_type::type& r);
