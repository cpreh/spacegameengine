...
#ifndef SGE_OPENGL_VOLUME_TEXTURE_CONTEXT_HPP_INCLUDED
#define SGE_OPENGL_VOLUME_TEXTURE_CONTEXT_HPP_INCLUDED
...
private:
	...
	GLenum const volume_texture_type_;
