...
//	case XK_Next:
	case XK_Page_Up:
		return sge::input::keyboard::key_code::pageup;
	case XK_Page_Down:
		return sge::input::keyboard::key_code::pagedown;
	case XK_End:
...
//	case XK_KP_Tab];
	case XK_KP_Enter:
		return sge::input::keyboard::key_code::num_enter;
/*	case XK_KP_F1];
	case XK_KP_F2];
	case XK_KP_F3];
	case XK_KP_F4];
	case XK_KP_Home:
		return sge::input::keyboard::key_code::NUM_HOME;
	case XK_KP_Left:
		return sge::input::keyboard::key_code::NUM_LEFT;
	case XK_KP_Up:
		return sge::input::keyboard::key_code::NUM_UP;
...
//	case XK_Shift_Lock:
//		return sge::input::keyboard::key_code::LSHIFT; // ???
...
#define XK_at              0x0040 /* U+0040 COMMERCIAL AT */
	...
	case XK_asciicircum:
		return sge::input::keyboard::key_code::circumflex;
	case XK_underscore:
