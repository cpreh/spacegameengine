...
sge::gui::size_policy::size_policy(
	axis_policy::type const &_x,
	axis_policy::type const &_y
)
:
	x_(_x),
	y_(_y)
...
sge::gui::size_policy::x() const
{
	return x_;
}

sge::gui::axis_policy::type const &
sge::gui::size_policy::y() const
{
	return y_;
}
...
sge::gui::axis_policy::type const &
sge::gui::size_policy::index(
	std::size_t const _i
) const
{
	return
		_i == static_cast<std::size_t>(0)
		?
			x()
		:
			y();
