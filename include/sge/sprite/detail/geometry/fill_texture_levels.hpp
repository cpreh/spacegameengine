...
#ifndef SGE_SPRITE_DETAIL_GEOMETRY_FILL_TEXTURE_LEVELS_HPP_INCLUDED
#define SGE_SPRITE_DETAIL_GEOMETRY_FILL_TEXTURE_LEVELS_HPP_INCLUDED
...
#include <sge/sprite/detail/geometry/fill_texture_level.hpp>
...
)
{
	sge::sprite::detail::apply_texture_levels<
		...
		>::type
	>(
		sge::sprite::detail::geometry::fill_texture_level<
			Iterator,
			Choices
		>(
			_iterator,
