...
#ifndef SGE_SPRITE_DETAIL_GEOMETRY_INDEX_ARRAY_HPP_INCLUDED
#define SGE_SPRITE_DETAIL_GEOMETRY_INDEX_ARRAY_HPP_INCLUDED
...
template<
	typename Choices
>
typename sge::sprite::detail::geometry::index_array<
	Choices
>::array const
