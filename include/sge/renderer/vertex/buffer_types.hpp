...
struct buffer_types
{
	...
	*/
	typedef sge::renderer::vf::dynamic::const_view const_view_type;

	/**
	\brief The view type returned when locking the buffer
	*/
	typedef sge::renderer::vf::dynamic::view view_type;
	...
	*/
	typedef sge::renderer::vertex::first first_type;
	...
	*/
	typedef sge::renderer::vertex::count count_type;
};
