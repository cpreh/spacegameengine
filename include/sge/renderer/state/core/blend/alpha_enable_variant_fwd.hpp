...
#ifndef SGE_RENDERER_STATE_CORE_BLEND_ALPHA_ENABLE_VARIANT_FWD_HPP_INCLUDED
#define SGE_RENDERER_STATE_CORE_BLEND_ALPHA_ENABLE_VARIANT_FWD_HPP_INCLUDED
