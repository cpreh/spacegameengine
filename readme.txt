...
renderer, input or font, and thus the test programs won't run.
Please follow the instructions below for your specific system.
...
VORIBS (build the vorbis loader plugin)
