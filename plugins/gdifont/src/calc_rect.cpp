...
sge::font::rect sge::gdifont::calc_rect(
...
{
  sge::gdifont::scoped_select const select_font(_device_context, _font);

  LONG const zero{0};

  RECT const result{sge::gdifont::draw_text(
      _device_context,
      _string,
      RECT{
          zero,
          ...
          fcppt::optional::maybe(
              sge::font::align_h::extract_max_width(_align_h),
              fcppt::const_(LONG{1}),
              [](sge::font::align_h::max_width const _max_width)
              { return fcppt::cast::size<LONG>(_max_width.get()); }),
          zero},
  ...
  LONG const pos_x{fcppt::variant::match(
      _align_h,
      [zero](sge::font::align_h::left const &) { return zero; },
      [width](sge::font::align_h::center const &_center)
      { return (fcppt::cast::size<LONG>(_center.max_width().get()) - width) / LONG{2}; },
      [width](sge::font::align_h::right const &_right)
      { return fcppt::cast::size<LONG>(_right.max_width().get()) - width; })};

  return sge::font::rect(
      sge::font::rect::vector(
          fcppt::cast::size<sge::font::rect::value_type>(pos_x),
          fcppt::cast::size<sge::font::rect::value_type>(zero)),
      sge::font::rect::dim(
