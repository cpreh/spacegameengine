...
std::endian sge::wave::info::endianness() const { return endianness_; }

sge::audio::channel_count sge::wave::info::channels() const { return channels_; }

sge::audio::sample_rate sge::wave::info::sample_rate() const { return sample_rate_; }

sge::audio::bits_per_sample sge::wave::info::bits_per_sample() const { return bits_per_sample_; }

sge::audio::sample_count sge::wave::info::samples() const { return samples_; }
