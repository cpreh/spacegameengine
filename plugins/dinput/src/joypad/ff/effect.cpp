...
sge::dinput::joypad::ff::effect::effect(
    ...
    : sge::input::joypad::ff::effect(),
      effect_{sge::dinput::joypad::ff::with_parameters(
          _button_map,
          _parameters,
          fcppt::function<sge::dinput::joypad::ff::dinput_effect_unique_ptr(DIEFFECT const &)>{
              [&_device, &_parameters](DIEFFECT const &_effect)
              {
                return sge::dinput::joypad::ff::create_effect(
                    _device,
                    sge::dinput::joypad::ff::variant_to_guid(_parameters.variant()),
                    _effect);
              }})},
      download_{*effect_}
{
...
void sge::dinput::joypad::ff::effect::play(
    sge::input::joypad::ff::optional_play_count const _play_count)
{
  sge::dinput::joypad::ff::start(*effect_, _play_count);
}

void sge::dinput::joypad::ff::effect::stop() { sge::dinput::joypad::ff::stop(*effect_); }
