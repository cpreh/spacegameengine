...
sge::dinput::joypad::ff::convert_type_parameters(sge::input::joypad::ff::variant const &_variant)
{
  return fcppt::variant::match(
      _variant,
      [](sge::input::joypad::ff::constant const &_constant)
      {
        return sge::dinput::joypad::ff::type_parameters{
            sge::dinput::joypad::ff::convert_constant(_constant)};
      },
      [](sge::input::joypad::ff::ramp const &_ramp) {
        return sge::dinput::joypad::ff::type_parameters{
            sge::dinput::joypad::ff::convert_ramp(_ramp)};
      },
      [](sge::input::joypad::ff::periodic const &_periodic)
      {
        return sge::dinput::joypad::ff::type_parameters{
            sge::dinput::joypad::ff::convert_periodic(_periodic)};
      },
      [](sge::input::joypad::ff::condition const &_condition)
      {
        return sge::dinput::joypad::ff::type_parameters{
            sge::dinput::joypad::ff::convert_condition(_condition)};
      });
}
