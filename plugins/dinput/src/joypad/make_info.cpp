...
sge::dinput::joypad::info sge::dinput::joypad::make_info(
    IDirectInputDevice8 &_device, sge::input::info::name const &_name, GUID const &_guid)
{
  sge::dinput::joypad::enumerator object(_device);

  sge::dinput::device::enumerate_objects(_device, object, DIDFT_AXIS | DIDFT_BUTTON);

  return sge::dinput::joypad::info(
      sge::input::joypad::info(
          sge::input::joypad::absolute_axis_info_container(
              sge::input::joypad::absolute_axis_info_container::vector{object.absolute_axis()}),
          sge::input::joypad::button_info_container(
              sge::input::joypad::button_info_container::vector{object.buttons()}),
          sge::input::joypad::relative_axis_info_container(
              sge::input::joypad::relative_axis_info_container::vector{object.relative_axis()}),
          sge::dinput::joypad::ff::enum_effects(_device),
          // TODO
          sge::input::info::name{_name},
          sge::input::info::unique_id(sge::dinput::guid_to_string(_guid))),
