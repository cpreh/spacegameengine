...
sge::dinput::joypad::info::info(
    ...
    : input_info_(_input_info),
      absolute_axis_map_(_absolute_axis_map),
      button_map_(_button_map),
      relative_axis_map_(_relative_axis_map)
{
}

sge::input::joypad::info const &sge::dinput::joypad::info::input_info() const
{
  return input_info_;
}

sge::dinput::joypad::absolute_axis_map const &sge::dinput::joypad::info::absolute_axis_map() const
{
  return absolute_axis_map_;
}

sge::dinput::joypad::button_map const &sge::dinput::joypad::info::button_map() const
{
  return button_map_;
}

sge::dinput::joypad::relative_axis_map const &sge::dinput::joypad::info::relative_axis_map() const
{
