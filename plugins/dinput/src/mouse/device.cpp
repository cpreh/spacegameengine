...
sge::dinput::mouse::device::on_dispatch(DIDEVICEOBJECTDATA const &_data)
{
  auto const axis_event{
      [&_data, this](sge::input::mouse::axis_id const _id) -> awl::event::optional_base_unique_ptr
      {
        return fcppt::optional::map(
            this->info_.input_info().axes()[_id],
            [this, _id, &_data](fcppt::reference<sge::input::mouse::axis_info const> const _info)
            {
              return fcppt::unique_ptr_to_base<awl::event::base>(
                  fcppt::make_unique_ptr<sge::input::mouse::event::axis>(
                      ...
                      sge::input::mouse::axis{_info->code(), _id},
  ...
  auto const button_event{
      [&_data, this](sge::input::mouse::button_id const _id) -> awl::event::optional_base_unique_ptr
      {
        return fcppt::optional::map(
            this->info_.input_info().buttons()[_id],
            [this, _id, &_data](fcppt::reference<sge::input::mouse::button_info const> const _info)
            {
              return fcppt::unique_ptr_to_base<awl::event::base>(
                  fcppt::make_unique_ptr<sge::input::mouse::event::button>(
                      sge::input::mouse::shared_ptr{this->fcppt_shared_from_this()},
                      sge::input::mouse::button{_info->code(), _id},
