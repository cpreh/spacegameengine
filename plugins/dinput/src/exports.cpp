...
sge::plugin::info const info(
    sge::plugin::name(FCPPT_TEXT("dinput")),
    sge::plugin::description(FCPPT_TEXT("Implements keyboards, mice and joypads via DirectInpu8.")),
...
sge::input::system_unique_ptr create_input_system(fcppt::log::context_reference const _log_context)
{
  return fcppt::unique_ptr_to_base<sge::input::system>(
      fcppt::make_unique_ptr<sge::dinput::system>(_log_context));
}
