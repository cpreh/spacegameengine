...
template <typename Type, typename Map, typename Info, typename Function>
awl::event::optional_base_unique_ptr conditional_event(
    fcppt::shared_ptr<Type> const _ptr,
