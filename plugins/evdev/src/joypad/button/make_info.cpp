...
sge::evdev::joypad::button::make_info(sge::evdev::joypad::button::code const _event)
{
  return sge::input::joypad::button_info(sge::evdev::joypad::button::make_string(_event));
}
