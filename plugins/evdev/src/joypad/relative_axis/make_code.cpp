...
sge::evdev::joypad::relative_axis::make_code(sge::evdev::joypad::relative_axis::code const _event)
{
  ...
  throw sge::input::exception{FCPPT_TEXT("Invalid relative axis code in evdev!")};
}
