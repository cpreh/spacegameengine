...
sge::evdev::joypad::relative_axis::make_info(sge::evdev::joypad::relative_axis::code const _event)
{
  return sge::input::joypad::relative_axis_info(
      sge::evdev::joypad::relative_axis::make_code(_event),
      sge::evdev::joypad::relative_axis::make_string(_event));
}
