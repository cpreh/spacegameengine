...
struct sampler_arg_type<sge::renderer::state::ffp::sampler::alpha_op, Arg>
{
  static GLenum get();
};

template <typename Arg>
struct sampler_arg_type<sge::renderer::state::ffp::sampler::color_op, Arg>
{
  static GLenum get();
};
...
#define SGE_OPENGL_STATE_CONVERT_DECLARE_SAMPLER_ALPHA_ARG_TYPE(seq, _, arg_type) \
  extern template struct sge::opengl::state::convert::sampler_arg_type< \
      sge::renderer::state::ffp::sampler::alpha_op, \
      sge::renderer::state::ffp::sampler::arg_type>;

#define SGE_OPENGL_STATE_CONVERT_DECLARE_SAMPLER_COLOR_ARG_TYPE(seq, _, arg_type) \
  extern template struct sge::opengl::state::convert::sampler_arg_type< \
