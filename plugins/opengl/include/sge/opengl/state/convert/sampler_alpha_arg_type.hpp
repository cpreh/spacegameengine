...
template <>
struct sampler_alpha_arg_type<sge::renderer::state::ffp::sampler::arg1>
{
  static GLenum get();
};

template <>
struct sampler_alpha_arg_type<sge::renderer::state::ffp::sampler::arg2>
{
  static GLenum get();
};

template <>
struct sampler_alpha_arg_type<sge::renderer::state::ffp::sampler::arg3>
{
  static GLenum get();
};
