...
#ifndef SGE_OPENGL_STATE_FFP_LIGHTING_LIGHT_POINT_HPP_INCLUDED
#define SGE_OPENGL_STATE_FFP_LIGHTING_LIGHT_POINT_HPP_INCLUDED
...
point(sge::renderer::state::ffp::lighting::light::point const &);
