...
#ifndef SGE_OPENGL_STATE_FFP_LIGHTING_MATERIAL_CREATE_HPP_INCLUDED
#define SGE_OPENGL_STATE_FFP_LIGHTING_MATERIAL_CREATE_HPP_INCLUDED
...
create(sge::renderer::state::ffp::lighting::material::parameters const &);
