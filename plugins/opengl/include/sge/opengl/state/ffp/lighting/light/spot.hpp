...
#ifndef SGE_OPENGL_STATE_FFP_LIGHTING_LIGHT_SPOT_HPP_INCLUDED
#define SGE_OPENGL_STATE_FFP_LIGHTING_LIGHT_SPOT_HPP_INCLUDED
...
spot(sge::renderer::state::ffp::lighting::light::spot const &);
