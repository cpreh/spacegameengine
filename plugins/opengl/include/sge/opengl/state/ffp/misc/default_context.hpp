...
public:
  using parameter = sge::opengl::state::ffp::misc::default_context_parameters;

  explicit default_context(parameter);

  ~default_context() override;

  [[nodiscard]] sge::opengl::state::ffp::misc::object const &default_state() const;

  static sge::opengl::context::id const static_id;

private:
  using object_unique_ptr = fcppt::unique_ptr<sge::opengl::state::ffp::misc::object>;
