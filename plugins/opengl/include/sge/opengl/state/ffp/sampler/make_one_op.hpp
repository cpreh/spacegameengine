...
sge::opengl::state::ffp::sampler::actor_vector make_one_op(OpType const &);

}

#define SGE_OPENGL_STATE_FFP_SAMPLER_DECLARE_MAKE_ONE_OP(seq, _, op_type) \
  extern template sge::opengl::state::ffp::sampler::actor_vector \
...
BOOST_PP_SEQ_FOR_EACH(
    SGE_OPENGL_STATE_FFP_SAMPLER_DECLARE_MAKE_ONE_OP, _, SGE_RENDERER_STATE_FFP_SAMPLER_PP_OP_TYPES)
