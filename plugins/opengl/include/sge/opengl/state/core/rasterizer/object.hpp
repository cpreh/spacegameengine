...
#include <sge/opengl/state/core/rasterizer/object_fwd.hpp> // IWYU pragma: export
...
extern template class sge::opengl::state::object<sge::renderer::state::core::rasterizer::object>;
