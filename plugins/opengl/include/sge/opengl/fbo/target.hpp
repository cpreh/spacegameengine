...
class target : public sge::opengl::target::basic<sge::renderer::target::offscreen>
{
  FCPPT_NONMOVABLE(target);

public:
  using base = sge::opengl::target::basic<sge::renderer::target::offscreen>;

  explicit target(sge::opengl::context::object_ref);
...
private:
  ...
  [[nodiscard]] sge::opengl::fbo::attachment_unique_ptr create_texture_binding(
      sge::opengl::texture::buffer_base_ref, sge::opengl::fbo::attachment_type);

  [[nodiscard]] sge::opengl::fbo::attachment_unique_ptr create_buffer_binding(
      sge::opengl::fbo::const_render_buffer_ref, sge::opengl::fbo::attachment_type);
  ...
  using attachment_map = std::
      unordered_map<sge::renderer::target::surface_index, sge::opengl::fbo::attachment_unique_ptr>;

  attachment_map color_attachments_;

  using optional_attachment_unique_ptr =
      fcppt::optional::object<sge::opengl::fbo::attachment_unique_ptr>;
