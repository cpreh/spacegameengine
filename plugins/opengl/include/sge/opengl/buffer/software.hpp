...
class software : public sge::opengl::buffer::base
{
  FCPPT_NONMOVABLE(software);
...
private:
  ...
  void bind_buffer(sge::opengl::buffer::optional_id const &) override;
  ...
  [[nodiscard]] sge::renderer::raw_pointer &buffer_object(sge::opengl::buffer::id);

  [[nodiscard]] sge::renderer::const_raw_pointer buffer_object(sge::opengl::buffer::id) const;
