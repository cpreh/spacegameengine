...
public:
  buffer(sge::opengl::context::object_ref, sge::renderer::index::buffer_parameters const &);

  ~buffer() override;

  [[nodiscard]] GLenum gl_format() const;

  [[nodiscard]] GLvoid *buffer_offset(sge::renderer::index::first) const;
