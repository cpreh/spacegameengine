...
{
  using base = sge::renderer::color_buffer::writable_volume;

  // TODO(philipp): Factor this out!
  using gl_buffer =
      sge::opengl::texture::basic_lockable_buffer<sge::opengl::texture::color_volume_types>;

  using dim_types = sge::opengl::texture::buffer_volume_types;
