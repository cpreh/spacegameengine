...
std::vector<fcppt::unique_ptr<typename Types::buffer_types::base>> init(
    ...
    fcppt::reference< // NOLINT(readability-avoid-const-params-in-decls)
        sge::opengl::texture::config<Types::buffer_types::dim_types::num_dims> const> const _config,
    sge::opengl::texture::type const _type, // NOLINT(readability-avoid-const-params-in-decls)
    sge::opengl::texture::buffer_type const
        _buffer_type, // NOLINT(readability-avoid-const-params-in-decls)
    sge::opengl::texture::id const _id // NOLINT(readability-avoid-const-params-in-decls)
)
{
  using extended_dim = sge::renderer::basic_dim<Types::buffer_types::dim_types::num_dims>;

  extended_dim const size(sge::opengl::texture::extend_size(_parameters.size()));
  ...
  sge::opengl::color_order const color_order(
      Types::buffer_types::format_types::convert_order()(format.gl_format()));

  sge::opengl::color_base_type const color_base_type(
      Types::buffer_types::format_types::convert_base_type()(format.gl_format()));

  sge::opengl::internal_color_format const internal_color_format(
      Types::buffer_types::format_types::convert_internal_format()(format.gl_format()));
  ...
  Types::buffer_types::dim_types::init_function().get()(
      ...
      sge::renderer::texture::mipmap::level(0U),
      size,
      nullptr);
  ...
  sge::opengl::texture::mipmap::create(
      ...
      sge::opengl::texture::mipmap::parameters<extended_dim::dim_wrapper::value>(
          fcppt::make_cref(_binding),
          _buffer_type,
          _config,
          color_order,
          color_base_type,
  ...
  sge::renderer::texture::mipmap::level_count const mip_levels(
      sge::opengl::texture::mipmap::get_levels(_parameters.mipmap(), size));
  ...
  return fcppt::algorithm::map<level_container>(
      fcppt::make_int_range_count(sge::renderer::texture::mipmap::level(mip_levels.get())),
      [&_binding,
       &_basic_parameters,
       _config,
       _type,
       ...
       format,
       internal_color_format,
       is_target](sge::renderer::texture::mipmap::level const _index)
      {
        return fcppt::unique_ptr_to_base<typename Types::buffer_types::base>(
            fcppt::make_unique_ptr<gl_buffer>(
                format.sge_format(),
                _config,
                sge::opengl::texture::basic_buffer_parameters(
                    fcppt::make_ref(_basic_parameters.log()),
                    fcppt::make_cref(_binding),
