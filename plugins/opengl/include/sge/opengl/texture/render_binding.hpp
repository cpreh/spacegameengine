...
class render_binding : public sge::opengl::texture::binding
{
  FCPPT_NONMOVABLE(render_binding);

public:
  render_binding(sge::opengl::texture::active_level const &, sge::opengl::texture::type);

  ~render_binding() override;
