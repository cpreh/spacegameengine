...
sge::opengl::texture::basic_buffer<Types>::basic_buffer(
    ...
    : base_type(),
      ...
      size_(sge::opengl::texture::get_level_size<dim::dim_wrapper::value>(
          _parameters.binding(), _parameters.buffer_type(), _parameters.level())),
      format_(_format)
{
}
...
{
template <typename Types>
basic_buffer<Types>::~basic_buffer() = default;
}
