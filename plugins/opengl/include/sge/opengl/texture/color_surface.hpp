...
#include <sge/opengl/texture/color_surface_fwd.hpp> // IWYU pragma: keep
#include <sge/opengl/texture/color_surface_types.hpp>
#include <sge/renderer/color_buffer/writable_surface.hpp> // IWYU pragma: keep
...
extern template class sge::opengl::texture::basic_buffer<sge::opengl::texture::color_surface_types>;
