...
{
  using format = sge::image::ds::format;

  using gl_format = format;

  using convert_order_function_type = sge::opengl::texture::convert_order_function<format>;

  [[nodiscard]] static convert_order_function_type convert_order();

  using convert_base_type_function = sge::opengl::texture::convert_base_type_function<format>;

  [[nodiscard]] static convert_base_type_function convert_base_type();

  using convert_internal_format_function =
      sge::opengl::texture::convert_internal_format_function<format>;
  ...
  [[nodiscard]] static format_result translate_format(format);
};
