...
class onscreen_surface : public sge::renderer::color_buffer::readable_surface
{
  FCPPT_NONMOVABLE(onscreen_surface);

public:
  explicit onscreen_surface(awl::window::object_ref);
...
private:
  ...
  [[nodiscard]] static sge::opengl::color_format gl_format();
  ...
  using optional_buffer_type = fcppt::optional::object<buffer_type>;
