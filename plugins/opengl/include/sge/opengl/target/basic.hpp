...
protected:
  basic(sge::opengl::context::object_ref, sge::renderer::target::viewport const &);
...
private:
  ...
  [[nodiscard]] sge::renderer::target::viewport viewport() const override;

  void scissor_area(sge::renderer::target::scissor_area const &) override;

  [[nodiscard]] sge::renderer::target::scissor_area scissor_area() const override;
  ...
  [[nodiscard]] virtual sge::renderer::screen_unit height() const = 0;
