...
{
public:
  FCPPT_DECLARE_STRONG_TYPEDEF(int, draw_to_window_flag);

  FCPPT_DECLARE_STRONG_TYPEDEF(int, support_opengl_flag);

  FCPPT_DECLARE_STRONG_TYPEDEF(int, double_buffer_flag);

  FCPPT_DECLARE_STRONG_TYPEDEF(int, pixel_type_flag);

  FCPPT_DECLARE_STRONG_TYPEDEF(int, pixel_type_rgba_flag);

  FCPPT_DECLARE_STRONG_TYPEDEF(int, color_bits_flag);

  FCPPT_DECLARE_STRONG_TYPEDEF(int, depth_bits_flag);

  FCPPT_DECLARE_STRONG_TYPEDEF(int, stencil_bits_flag);

  // Same signature for ARB and EXT
  using wgl_choose_pixel_format = sge::opengl::fun_ref<PFNWGLCHOOSEPIXELFORMATARBPROC>;
  ...
  sge::opengl::wgl::visual::pixel_format_types::draw_to_window_flag draw_to_window() const;

  sge::opengl::wgl::visual::pixel_format_types::support_opengl_flag support_opengl() const;

  sge::opengl::wgl::visual::pixel_format_types::double_buffer_flag double_buffer() const;

  sge::opengl::wgl::visual::pixel_format_types::pixel_type_flag pixel_type() const;

  sge::opengl::wgl::visual::pixel_format_types::pixel_type_rgba_flag pixel_type_rgba() const;

  sge::opengl::wgl::visual::pixel_format_types::color_bits_flag color_bits() const;

  sge::opengl::wgl::visual::pixel_format_types::depth_bits_flag depth_bits() const;

  sge::opengl::wgl::visual::pixel_format_types::stencil_bits_flag stencil_bits() const;

  sge::opengl::wgl::visual::pixel_format_types::wgl_choose_pixel_format choose_pixel_format() const;
