...
public:
  ...
  [[nodiscard]] sge::renderer::vf::dynamic::part const &get() const;

  void use_me(sge::opengl::vf::pointer) const;
...
private:
  ...
  using actor_unique_ptr = fcppt::unique_ptr<sge::opengl::vf::actor>;

  using actor_container = std::vector<actor_unique_ptr>;
