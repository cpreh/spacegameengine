...
class loaded_object : public sge::renderer::cg::loaded_texture
{
...
public:
  ...
  [[nodiscard]] sge::renderer::texture::stage enable() const;
...
private:
  ...
  fcppt::reference<sge::opengl::texture::bind_context> const bind_context_;

  sge::cg::parameter::object const parameter_;

  fcppt::reference<sge::opengl::texture::base const> const texture_;
