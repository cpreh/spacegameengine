...
class multi_sample_context : public sge::opengl::context::base
{
  FCPPT_NONMOVABLE(multi_sample_context);

public:
  using parameter = sge::opengl::info::context const &;

  explicit multi_sample_context(sge::opengl::info::context const &);

  ~multi_sample_context() override;
