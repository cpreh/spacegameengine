...
sge::opengl::egl::window_surface<NativeWindow>::window_surface(
...
{
  if (surface_ == sge::opengl::egl::no_surface())
  {
    throw sge::renderer::exception{FCPPT_TEXT("eglCreateWindowSurface failed")};
  }
}
...
template <typename NativeWindow>
EGLSurface sge::opengl::egl::window_surface<NativeWindow>::get() const
{
  return surface_;
}
