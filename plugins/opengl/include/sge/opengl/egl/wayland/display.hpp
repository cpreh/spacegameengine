...
class display : public sge::opengl::egl::display
{
  FCPPT_NONMOVABLE(display);

public:
  display(fcppt::log::object_reference, awl::backends::wayland::system::object_ref);
...
private:
  ...
  [[nodiscard]] awl::visual::object_unique_ptr create_visual(
      sge::opengl::egl::init const &, sge::renderer::pixel_format::object const &) override;
