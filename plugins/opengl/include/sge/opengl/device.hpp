...
private:
  ...
  [[nodiscard]] sge::renderer::target::offscreen_unique_ptr create_target() override;

  [[nodiscard]] sge::renderer::texture::planar_unique_ptr
  create_planar_texture(renderer::texture::planar_parameters const &) override;

  [[nodiscard]] sge::renderer::texture::depth_stencil_unique_ptr
  create_depth_stencil_texture(sge::renderer::texture::depth_stencil_parameters const &) override;

  [[nodiscard]] sge::renderer::depth_stencil_buffer::surface_unique_ptr
  create_depth_stencil_surface(
      sge::renderer::depth_stencil_buffer::surface_parameters const &) override;

  [[nodiscard]] sge::renderer::texture::volume_unique_ptr
  create_volume_texture(sge::renderer::texture::volume_parameters const &) override;

  [[nodiscard]] sge::renderer::texture::cube_unique_ptr
  create_cube_texture(sge::renderer::texture::cube_parameters const &) override;

  [[nodiscard]] sge::renderer::vertex::declaration_unique_ptr
  create_vertex_declaration(sge::renderer::vertex::declaration_parameters const &) override;

  [[nodiscard]] sge::renderer::vertex::buffer_unique_ptr
  create_vertex_buffer(sge::renderer::vertex::buffer_parameters const &) override;

  [[nodiscard]] sge::renderer::index::buffer_unique_ptr
  create_index_buffer(sge::renderer::index::buffer_parameters const &) override;

  [[nodiscard]] sge::renderer::occlusion_query::object_unique_ptr create_occlusion_query() override;

  [[nodiscard]] sge::renderer::state::core::blend::object_unique_ptr
  create_blend_state(sge::renderer::state::core::blend::parameters const &) override;

  [[nodiscard]] sge::renderer::state::core::depth_stencil::object_unique_ptr
  create_depth_stencil_state(
      sge::renderer::state::core::depth_stencil::parameters const &) override;

  [[nodiscard]] sge::renderer::state::core::rasterizer::object_unique_ptr
