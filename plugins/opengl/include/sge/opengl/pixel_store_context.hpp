...
class pixel_store_context : public sge::opengl::context::base
{
  FCPPT_NONMOVABLE(pixel_store_context);

public:
  pixel_store_context();

  ~pixel_store_context() override;

  void unpack_alignment(sge::opengl::unpack_alignment);

  [[nodiscard]] sge::opengl::unpack_alignment unpack_alignment() const;
