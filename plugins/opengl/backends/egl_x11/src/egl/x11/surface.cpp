...
sge::opengl::egl::x11::surface::surface(
    ...
    : sge::opengl::egl::surface(), surface_{_display, _config, _surface.get().get()}
{
}

sge::opengl::egl::x11::surface::~surface() = default;

EGLSurface sge::opengl::egl::x11::surface::get() const { return surface_.get(); }
