...
void sge::opengl::windows::visual::set_format(
...
{
  if (::SetPixelFormat(_device.hdc(), _format.get(), &_format_desc) == FALSE)
    throw sge::renderer::exception(FCPPT_TEXT("SetPixelFormat() failed"));
}
