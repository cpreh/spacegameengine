...
sge::renderer::display_mode::optional_pixel_size sge::opengl::xrandr::combine_pixel_sizes(
    sge::renderer::display_mode::optional_pixel_size const &_previous,
    sge::renderer::display_mode::pixel_size const &_next)
{
  return _previous.has_value() ? sge::renderer::display_mode::optional_pixel_size()
                               : sge::renderer::display_mode::optional_pixel_size(_next);
}
