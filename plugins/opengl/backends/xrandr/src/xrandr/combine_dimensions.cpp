...
sge::renderer::display_mode::optional_dimensions sge::opengl::xrandr::combine_dimensions(
    sge::renderer::display_mode::optional_dimensions const &_previous,
    sge::renderer::display_mode::dimensions const &_next)
{
  return _previous.has_value() ? _previous
                               : sge::renderer::display_mode::optional_dimensions(_next);
}
