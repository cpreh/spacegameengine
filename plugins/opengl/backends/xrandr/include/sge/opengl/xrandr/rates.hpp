...
{
public:
  rates(sge::opengl::xrandr::const_configuration_ref, sge::opengl::xrandr::mode_index);

  using int_type = sge::opengl::xrandr::refresh_rate_type;

  using iterator = int_type const *;
