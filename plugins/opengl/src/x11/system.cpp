...
sge::opengl::x11::system::system(
    ...
    : log_{_log},
      ...
      wm_fullscreen_{
          awl::backends::x11::intern_atom(_awl_system.get().display(), "_NET_WM_STATE_FULLSCREEN")}
{
}

sge::opengl::x11::system::~system() = default;

sge::opengl::platform::device_state_unique_ptr sge::opengl::x11::system::create_device_state(
    ...
    sge::window::object_ref const _window)
{
  return fcppt::unique_ptr_to_base<sge::opengl::platform::device_state>(
      fcppt::make_unique_ptr<sge::opengl::x11::device_state>(
          this->log_,
          fcppt::optional::deref(this->xrandr_system_),
          _fullscreen,
          _window,
          this->wm_state_,
          this->wm_fullscreen_));
