...
sge::cg::program::source sge::opengl::cg::program::transform_vertex(
    sge::renderer::vertex::declaration const &, sge::cg::program::source const &_source)
{
  return sge::cg::program::replace_extra(
      _source, sge::cg::program::replace_extra_callback(sge::opengl::cg::program::replace_index));
}
