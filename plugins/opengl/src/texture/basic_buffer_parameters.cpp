...
sge::opengl::texture::basic_buffer_parameters::basic_buffer_parameters(
    ...
    : log_{_log},
      ...
      color_order_(_color_order),
      color_base_type_(_color_base_type),
      internal_color_format_(_internal_color_format),
      is_render_target_(_is_render_target)
{
}

fcppt::log::object &sge::opengl::texture::basic_buffer_parameters::log() const
{
  return log_.get();
}

sge::opengl::texture::binding const &sge::opengl::texture::basic_buffer_parameters::binding() const
{
  return binding_.get();
}

sge::opengl::context::object &sge::opengl::texture::basic_buffer_parameters::context() const
{
  return context_.get();
}

sge::renderer::texture::mipmap::level sge::opengl::texture::basic_buffer_parameters::level() const
{
  return level_;
}

sge::opengl::texture::type sge::opengl::texture::basic_buffer_parameters::type() const
{
  return type_;
}

sge::opengl::texture::buffer_type sge::opengl::texture::basic_buffer_parameters::buffer_type() const
{
  return buffer_type_;
}

sge::opengl::texture::id sge::opengl::texture::basic_buffer_parameters::id() const { return id_; }
...
sge::opengl::color_order sge::opengl::texture::basic_buffer_parameters::color_order() const
{
  return color_order_;
}

sge::opengl::color_base_type sge::opengl::texture::basic_buffer_parameters::color_base_type() const
{
  return color_base_type_;
}
