...
sge::renderer::texture::volume_unique_ptr sge::opengl::texture::create_volume(
    ...
    sge::renderer::texture::volume_parameters const &_parameters)
{
  return fcppt::unique_ptr_to_base<sge::renderer::texture::volume>(
      fcppt::make_unique_ptr<sge::opengl::texture::volume>(
          fcppt::optional::to_exception(
              ...
              []
              {
                return sge::renderer::unsupported{
                    FCPPT_TEXT("volume texture"), FCPPT_TEXT("1.2"), FCPPT_TEXT("")};
              }),
          _basic_parameters,
          _parameters));
}
