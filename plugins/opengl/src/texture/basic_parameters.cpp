...
fcppt::log::object &sge::opengl::texture::basic_parameters::log() const { return log_.get(); }

sge::opengl::context::object &sge::opengl::texture::basic_parameters::context() const
{
  return context_.get();
}
