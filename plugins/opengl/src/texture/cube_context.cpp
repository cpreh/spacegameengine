...
sge::opengl::texture::cube_context::~cube_context() = default;

sge::opengl::texture::optional_cube_config const &sge::opengl::texture::cube_context::config() const
{
  return config_;
}
...
sge::opengl::context::id const
    sge::opengl::texture::cube_context::static_id(sge::opengl::context::make_id());
