...
sge::opengl::texture::cube_config::cube_config(
    ...
    : cube_texture_type_(_cube_texture_type), cube_sides_(_cube_sides)
{
}

sge::opengl::texture::type sge::opengl::texture::cube_config::cube_texture_type() const
{
  return cube_texture_type_;
}

sge::opengl::texture::cube_side_array const &sge::opengl::texture::cube_config::cube_sides() const
{
  return cube_sides_;
}
