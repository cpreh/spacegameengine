...
sge::renderer::size_type sge::opengl::texture::buffer_surface_types::min_size()
{
  return 64U; // NOLINT(cppcoreguidelines-avoid-magic-numbers,readability-magic-numbers)
}

sge::opengl::texture::buffer_surface_types::init_function_type
sge::opengl::texture::buffer_surface_types::init_function()
{
  return fcppt::make_ref(sge::opengl::texture::funcs::set_2d);
}

sge::opengl::texture::buffer_surface_types::sub_function_type
sge::opengl::texture::buffer_surface_types::sub_function()
{
  return fcppt::make_ref(sge::opengl::texture::funcs::set_rect);
}
