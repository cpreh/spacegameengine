...
sge::opengl::texture::mipmap::context::context(sge::opengl::info::context const &_info)
    : sge::opengl::context::base(),
      generate_mipmap_flag_(
          sge::opengl::info::version_at_least(
              ...
              ? sge::opengl::optional_enum(sge::opengl::convert::to_gl_enum<GL_GENERATE_MIPMAP>())
      ...
      generate_mipmap_(
          sge::opengl::info::version_at_least(
              ...
              ? optional_gl_generate_mipmap(sge::opengl::deref_fun_ptr(
                    sge::opengl::info::cast_function<PFNGLGENERATEMIPMAPPROC>(
                        _info.load_function("glGenerateMipmap"))))
              : optional_gl_generate_mipmap())
{
}

sge::opengl::texture::mipmap::context::~context() = default;

sge::opengl::optional_enum sge::opengl::texture::mipmap::context::generate_mipmap_flag() const
{
...
sge::opengl::context::id const
    sge::opengl::texture::mipmap::context::static_id(sge::opengl::context::make_id());
