...
void sge::opengl::texture::mipmap::all_levels(
  ...
  else
  {
    sge::opengl::texture::mipmap::generate_levels(
        ...
        sge::renderer::texture::mipmap::level_count(
            std::numeric_limits<sge::renderer::texture::mipmap::level_count::value_type>::max()));
  }
}

#define SGE_OPENGL_TEXTURE_MIPMAP_INSTANTIATE_ALL_LEVELS(seq, _, dimension) \
  template void sge::opengl::texture::mipmap::all_levels<dimension>( \
      fcppt::log::object &, \
...
BOOST_PP_SEQ_FOR_EACH(
    SGE_OPENGL_TEXTURE_MIPMAP_INSTANTIATE_ALL_LEVELS, _, SGE_OPENGL_TEXTURE_PP_DIMS)
