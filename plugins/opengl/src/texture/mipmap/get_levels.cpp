...
sge::renderer::texture::mipmap::level_count sge::opengl::texture::mipmap::get_levels(
    ...
    sge::renderer::basic_dim<Size> const &_dim)
{
  return fcppt::variant::match(
      ...
      { return sge::renderer::texture::mipmap::level_count(1U); },
      [&_dim](sge::renderer::texture::mipmap::all_levels_rep const &)
      {
        return fcppt::strong_typedef_construct_cast<
            ...
            1U + fcppt::math::log2(
                     // TODO(philipp)!
                     *boost::range::max_element(fcppt::math::to_array(_dim))));
      },
      [](sge::renderer::texture::mipmap::levels_rep const &_levels) { return _levels.value(); });
}

#define SGE_OPENGL_TEXTURE_MIPMAP_INSTANTIATE_GET_LEVELS(seq, _, dimension) \
  template sge::renderer::texture::mipmap::level_count \
  sge::opengl::texture::mipmap::get_levels<dimension>( \
      sge::renderer::texture::mipmap::object const &, \
      sge::renderer::basic_dim<dimension> const &);

BOOST_PP_SEQ_FOR_EACH(
    SGE_OPENGL_TEXTURE_MIPMAP_INSTANTIATE_GET_LEVELS, _, SGE_OPENGL_TEXTURE_PP_DIMS)
