    ...
    void const *const _pointer)
{
  sge::opengl::call_fun_ref(
      _config.vertex_attrib_pointer(), _index, _size, _type, _normalized, _stride, _pointer);

  SGE_OPENGL_CHECK_STATE(
      FCPPT_TEXT("Setting a vertex attribute pointer failed"), sge::renderer::exception)
}
