    ...
    sge::opengl::vf::attribute_context const &_context, GLuint const _index)
{
  sge::opengl::call_fun_ref(
      sge::opengl::vf::get_attribute_config(_context).disable_vertex_attrib_array(), _index);

  SGE_OPENGL_CHECK_STATE(
      FCPPT_TEXT("Disabling a vertex attrib array failed"), sge::renderer::exception)
}
