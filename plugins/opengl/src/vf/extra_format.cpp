...
GLenum sge::opengl::vf::extra_format(sge::renderer::vf::dynamic::extra_any const &_any)
{
  return fcppt::variant::match(
      _any,
      [](sge::renderer::vf::dynamic::vector const &_vector)
      { return sge::opengl::vf::convert_element_type(_vector.element_type()); },
      [](sge::renderer::vf::dynamic::color const &_color)
      {
        return sge::opengl::convert::color_base_type_sge(
