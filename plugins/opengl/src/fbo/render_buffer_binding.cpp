...
sge::opengl::fbo::render_buffer_binding::render_buffer_binding(
    ...
    : context_(_context), what_(_what)
{
  sge::opengl::fbo::attach_render_buffer(_context.get(), _what, _render_buffer.get().id());
}

sge::opengl::fbo::render_buffer_binding::~render_buffer_binding()
{
  sge::opengl::fbo::attach_render_buffer(context_.get(), what_, 0);
}
