    ...
    sge::renderer::depth_stencil_buffer::surface_parameters const &_parameters)
{
  return fcppt::unique_ptr_to_base<sge::renderer::depth_stencil_buffer::surface>(
      fcppt::make_unique_ptr<sge::opengl::fbo::depth_stencil_surface>(
          fcppt::make_cref(sge::opengl::fbo::get_config(
              fcppt::make_cref(sge::opengl::context::use<sge::opengl::fbo::context>(
