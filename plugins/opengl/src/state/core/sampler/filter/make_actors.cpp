    ...
    sge::renderer::state::core::sampler::filter::parameters const &_parameters)
{
  return fcppt::variant::match(
      ...
      { return sge::opengl::state::core::sampler::filter::anisotropic(_context, _filter); },
      [_context](sge::renderer::state::core::sampler::filter::normal::parameters const &_filter)
      { return sge::opengl::state::core::sampler::filter::normal(_context, _filter); });
}
