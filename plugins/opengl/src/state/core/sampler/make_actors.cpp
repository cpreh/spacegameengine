...
sge::opengl::state::core::sampler::actor_vector sge::opengl::state::core::sampler::make_actors(
    sge::opengl::context::object_ref const _context,
    sge::renderer::state::core::sampler::parameters const &_parameters)
{
  return fcppt::container::join(
      sge::opengl::state::core::sampler::address::make_actors(_parameters.address()),
      sge::opengl::state::core::sampler::filter::make_actors(_context, _parameters.filter()));
}
