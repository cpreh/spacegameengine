...
sge::opengl::state::actor_vector sge::opengl::state::core::depth_stencil::stencil::make_actors(
  ...
  return fcppt::variant::match(
      ...
      [](sge::renderer::state::core::depth_stencil::stencil::off const &)
      {
        return sge::opengl::state::actor_vector{
            sge::opengl::state::actor{[] { sge::opengl::disable(GL_STENCIL_TEST); }},
            sge::opengl::state::core::depth_stencil::stencil::write_mask(
                sge::renderer::state::core::depth_stencil::stencil::write_mask_all())};
      },
      [_context](sge::renderer::state::core::depth_stencil::stencil::enabled const &_enabled)
      {
        return fcppt::container::join(
            sge::opengl::state::actor_vector{
                sge::opengl::state::actor{[] { sge::opengl::enable(GL_STENCIL_TEST); }}},
