...
sge::opengl::state::core::depth_stencil::stencil::config::config(
    gl_stencil_func_separate _stencil_func_separate, gl_stencil_op_separate _stencil_op_separate)
    : stencil_func_separate_(_stencil_func_separate), stencil_op_separate_(_stencil_op_separate)
{
}
