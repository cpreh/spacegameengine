...
void sge::opengl::state::core::rasterizer::set(
    sge::opengl::context::object &_context,
    sge::renderer::state::core::rasterizer::const_optional_object_ref const &_state)
{
  sge::opengl::state::set_or_default_single<sge::opengl::state::core::rasterizer::object>(
      sge::opengl::context::use<sge::opengl::state::core::rasterizer::default_context>(
