...
void sge::opengl::state::core::set_defaults(sge::opengl::context::object &_context)
{
  sge::opengl::state::core::blend::set(
      _context, sge::renderer::state::core::blend::const_optional_object_ref());

  sge::opengl::state::core::depth_stencil::set(
      _context, sge::renderer::state::core::depth_stencil::const_optional_object_ref());

  sge::opengl::state::core::rasterizer::set(
      _context, sge::renderer::state::core::rasterizer::const_optional_object_ref());

  sge::opengl::state::core::sampler::set_defaults(_context);
}
