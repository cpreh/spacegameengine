...
sge::opengl::state::ffp::transform::default_context::default_context(
    sge::opengl::state::ffp::transform::default_context::parameter _context)
    : sge::opengl::context::base(),
      default_state_(fcppt::make_unique_ptr<sge::opengl::state::ffp::transform::object>(
          sge::opengl::state::ffp::transform::make_actors(
              _context, sge::renderer::state::ffp::transform::default_())))
{
}

sge::opengl::state::ffp::transform::default_context::~default_context() = default;
...
sge::opengl::context::id const
    sge::opengl::state::ffp::transform::default_context::static_id(sge::opengl::context::make_id());
