...
void sge::opengl::state::ffp::alpha_test::set(
    sge::opengl::context::object &_context,
    sge::renderer::state::ffp::alpha_test::const_optional_object_ref const &_state)
{
  sge::opengl::state::set_or_default_single<sge::opengl::state::ffp::alpha_test::object>(
      sge::opengl::context::use<sge::opengl::state::ffp::alpha_test::default_context>(
