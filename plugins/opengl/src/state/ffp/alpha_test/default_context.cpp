...
sge::opengl::state::ffp::alpha_test::default_context::default_context()
    : sge::opengl::context::base(),
      default_state_(fcppt::make_unique_ptr<sge::opengl::state::ffp::alpha_test::object>(
          sge::opengl::state::ffp::alpha_test::make_actors(
              sge::renderer::state::ffp::alpha_test::default_())))
{
}

sge::opengl::state::ffp::alpha_test::default_context::~default_context() = default;
...
sge::opengl::context::id const sge::opengl::state::ffp::alpha_test::default_context::static_id(
