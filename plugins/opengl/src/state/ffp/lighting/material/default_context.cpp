...
#include <sge/renderer/state/ffp/lighting/material/parameters.hpp> // NOLINT(misc-include-cleaner)
...
sge::opengl::state::ffp::lighting::material::default_context::default_context()
    : sge::opengl::context::base(),
      default_state_(fcppt::make_unique_ptr<sge::opengl::state::ffp::lighting::material::object>(
          sge::opengl::state::ffp::lighting::material::make_actors(
              sge::renderer::state::ffp::lighting::material::default_())))
{
}

sge::opengl::state::ffp::lighting::material::default_context::~default_context() = default;
