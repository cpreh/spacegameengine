...
sge::opengl::state::index_actor_vector sge::opengl::state::ffp::lighting::light::directional(
    sge::renderer::state::ffp::lighting::light::directional const &_directional)
{
  return sge::opengl::state::index_actor_vector{
      sge::opengl::state::ffp::lighting::light::position_impl(fcppt::math::vector::push_back(
