...
sge::opengl::state::index_actor sge::opengl::state::ffp::lighting::light::position(
    sge::renderer::state::ffp::lighting::light::position const &_position)
{
  return sge::opengl::state::ffp::lighting::light::position_impl(
      fcppt::math::vector::push_back(_position.get(), 1.F));
}
