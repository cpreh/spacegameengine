...
void sge::opengl::state::ffp::lighting::light::set(
    sge::opengl::context::object &_context,
    sge::renderer::state::ffp::lighting::light::const_object_ref_vector const &_lights)
{
  sge::opengl::state::set_array<sge::opengl::state::ffp::lighting::light::object>(
      sge::opengl::context::use<sge::opengl::state::ffp::lighting::light::context>(
