...
sge::opengl::state::index_actor_vector sge::opengl::state::ffp::lighting::light::spot(
    sge::renderer::state::ffp::lighting::light::spot const &_spot)
{
  return fcppt::container::join(
      sge::opengl::state::index_actor_vector{
          sge::opengl::state::ffp::lighting::light::position(_spot.position()),
          sge::opengl::state::ffp::lighting::light::direction(_spot.direction()),
          sge::opengl::state::ffp::lighting::light::cutoff_angle(_spot.cutoff_angle())},
      sge::opengl::state::ffp::lighting::light::attenuation(_spot.attenuation()));
}
