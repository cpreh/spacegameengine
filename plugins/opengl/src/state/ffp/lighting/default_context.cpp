...
#include <sge/renderer/state/ffp/lighting/parameters.hpp> // NOLINT(misc-include-cleaner)
...
sge::opengl::state::ffp::lighting::default_context::default_context()
    : sge::opengl::context::base(),
      default_state_(fcppt::make_unique_ptr<sge::opengl::state::ffp::lighting::object>(
          sge::opengl::state::ffp::lighting::make_actors(
              sge::renderer::state::ffp::lighting::default_())))
{
}

sge::opengl::state::ffp::lighting::default_context::~default_context() = default;
...
sge::opengl::context::id const
    sge::opengl::state::ffp::lighting::default_context::static_id(sge::opengl::context::make_id());
