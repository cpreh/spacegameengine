...
void sge::opengl::state::ffp::lighting::set(
    sge::opengl::context::object &_context,
    sge::renderer::state::ffp::lighting::const_optional_object_ref const &_state)
{
  sge::opengl::state::set_or_default_single<sge::opengl::state::ffp::lighting::object>(
      sge::opengl::context::use<sge::opengl::state::ffp::lighting::default_context>(
