...
sge::opengl::state::ffp::fog::default_context::default_context()
    : sge::opengl::context::base(),
      default_state_(fcppt::make_unique_ptr<sge::opengl::state::ffp::fog::object>(
          sge::opengl::state::ffp::fog::make_actors(sge::renderer::state::ffp::fog::default_())))
{
}

sge::opengl::state::ffp::fog::default_context::~default_context() = default;
...
sge::opengl::context::id const
    sge::opengl::state::ffp::fog::default_context::static_id(sge::opengl::context::make_id());
