...
void sge::opengl::state::ffp::fog::set(
    sge::opengl::context::object &_context,
    sge::renderer::state::ffp::fog::const_optional_object_ref const &_state)
{
  sge::opengl::state::set_or_default_single<sge::opengl::state::ffp::fog::object>(
      sge::opengl::context::use<sge::opengl::state::ffp::fog::default_context>(
