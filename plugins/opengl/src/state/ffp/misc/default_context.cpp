...
sge::opengl::state::ffp::misc::default_context::default_context(
    ...
    : sge::opengl::context::base(),
      default_state_(fcppt::make_unique_ptr<sge::opengl::state::ffp::misc::object>(
          sge::opengl::state::ffp::misc::make_actors(
              _parameter.log(), _parameter.context(), sge::renderer::state::ffp::misc::default_())))
{
}

sge::opengl::state::ffp::misc::default_context::~default_context() = default;
...
sge::opengl::context::id const
    sge::opengl::state::ffp::misc::default_context::static_id(sge::opengl::context::make_id());
