...
void sge::opengl::state::ffp::misc::point_sprite::set_texture(
    ...
    sge::renderer::state::ffp::misc::enable_point_sprites const _enable)
{
  ...
  sge::opengl::texture::funcs::env_int(
      active_level,
      sge::opengl::texture::funcs::env_target{_point_sprite_config.point_sprite_flag().get()},
      sge::opengl::texture::funcs::env_arg{_point_sprite_config.coord_replace_flag().get()},
      fcppt::strong_typedef_construct_cast<
          sge::opengl::texture::funcs::env_int_value,
          fcppt::cast::static_cast_fun>(sge::opengl::convert::to_gl_bool(_enable.get())));
}
