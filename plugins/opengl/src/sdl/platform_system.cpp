...
sge::opengl::sdl::platform_system::platform_system(awl::backends::sdl::system::object_ref)
    : sge::opengl::platform::system{}
{
}

sge::opengl::sdl::platform_system::~platform_system() = default;
    ...
    sge::window::object_ref const _window)
{
  return fcppt::unique_ptr_to_base<sge::opengl::platform::device_state>(
      fcppt::make_unique_ptr<sge::opengl::sdl::device_state>(_fullscreen, _window));
}
