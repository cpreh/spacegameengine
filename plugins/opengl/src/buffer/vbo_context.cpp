...
sge::opengl::buffer::vbo_context::vbo_context(sge::opengl::context::object_ref const _context)
    : sge::opengl::context::base(),
      buffers_(fcppt::optional::maybe( // NOLINT(clang-analyzer-cplusplus.NewDeleteLeaks)
          ...
          {
            return _config.is_native().get() // NOLINT(clang-analyzer-cplusplus.NewDeleteLeaks)
                       ? // NOLINT(bugprone-branch-clone)
                       sge::opengl::buffer::make_hardware(
                           fcppt::make_cref(_config), GL_ELEMENT_ARRAY_BUFFER, GL_ARRAY_BUFFER)
                       : sge::opengl::buffer::make_hardware(
...
sge::opengl::buffer::vbo_context::~vbo_context() = default;

sge::opengl::buffer::base &sge::opengl::buffer::vbo_context::index_buffer() const
{
  return *fcppt::array::get<0>(buffers_);
}

sge::opengl::buffer::base &sge::opengl::buffer::vbo_context::vertex_buffer() const
{
...
sge::opengl::context::id const
    sge::opengl::buffer::vbo_context::static_id(sge::opengl::context::make_id());
