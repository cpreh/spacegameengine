...
sge::opengl::windows::visual::object::object(
    ...
    : awl::backends::windows::visual::object(), config_(_config), format_(_format)
{
}

sge::opengl::windows::visual::object::~object() {}

void sge::opengl::windows::visual::object::apply(HWND const _hwnd) const
{
  sge::opengl::windows::visual::choose_and_set_format(config_, _hwnd, format_);
}
