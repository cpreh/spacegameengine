...
sge::opengl::egl::x11::display::display(
    ...
    : sge::opengl::egl::display(),
      log_{_log},
      x11_display_{_awl_system.get().display()},
      display_{sge::opengl::egl::get_display(x11_display_.get().get())}
{
}

sge::opengl::egl::x11::display::~display() = default;

EGLDisplay sge::opengl::egl::x11::display::get() const { return display_; }

awl::visual::object_unique_ptr sge::opengl::egl::x11::display::create_visual(
    sge::opengl::egl::init const &, sge::renderer::pixel_format::object const &_pixel_format)
{
  return fcppt::unique_ptr_to_base<awl::visual::object>(
      fcppt::make_unique_ptr<sge::opengl::egl::x11::visual>(
          log_.get(), fcppt::reference_to_const(x11_display_), display_, _pixel_format));
}

sge::opengl::egl::surface_unique_ptr sge::opengl::egl::x11::display::create_surface(
    EGLConfig const _config, // NOLINT(misc-misplaced-const)
    sge::window::object_ref const _window)
{
  return fcppt::unique_ptr_to_base<sge::opengl::egl::surface>(
      fcppt::make_unique_ptr<sge::opengl::egl::x11::surface>(
          display_,
          _config,
          fcppt::optional::to_exception(
              fcppt::cast::dynamic<awl::backends::x11::window::base const>(
