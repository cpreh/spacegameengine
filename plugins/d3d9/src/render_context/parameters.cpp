...
sge::d3d9::render_context::parameters::parameters(
    ...
    : device_(_device),
      ...
      core_defaults_(_core_defaults),
      ffp_defaults_(_ffp_defaults)
{
}

IDirect3DDevice9 &sge::d3d9::render_context::parameters::device() const { return device_.get(); }

sge::renderer::target::base &sge::d3d9::render_context::parameters::target() const
{
  return target_.get();
}
...
sge::d3d9::state::core::defaults const &sge::d3d9::render_context::parameters::core_defaults() const
{
  return core_defaults_.get();
}

sge::d3d9::state::ffp::defaults const &sge::d3d9::render_context::parameters::ffp_defaults() const
{
  return ffp_defaults_.get();
}
