...
sge::d3d9::state::core::sampler::state_vector sge::d3d9::state::core::sampler::address::make_states(
    sge::renderer::state::core::sampler::address::parameters const &_parameters)
{
  return sge::d3d9::state::core::sampler::state_vector{
      sge::d3d9::state::core::sampler::state(
          D3DSAMP_ADDRESSU, sge::d3d9::state::convert::address_mode(_parameters.mode_s().get())),
      sge::d3d9::state::core::sampler::state(
          D3DSAMP_ADDRESSV, sge::d3d9::state::convert::address_mode(_parameters.mode_t().get())),
      sge::d3d9::state::core::sampler::state(
          D3DSAMP_ADDRESSW, sge::d3d9::state::convert::address_mode(_parameters.mode_u().get()))};
}
