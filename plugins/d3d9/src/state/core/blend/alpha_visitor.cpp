...
sge::d3d9::state::core::blend::alpha_visitor::operator()(
    sge::renderer::state::core::blend::alpha_off const &) const
{
  return sge::d3d9::state::render_vector{sge::d3d9::state::render(D3DRS_ALPHABLENDENABLE, FALSE)};
}

sge::d3d9::state::core::blend::alpha_visitor::result_type
sge::d3d9::state::core::blend::alpha_visitor::operator()(
    sge::renderer::state::core::blend::alpha_enabled const &_enabled) const
{
  return fcppt::container::join(
      sge::d3d9::state::render_vector{sge::d3d9::state::render(D3DRS_ALPHABLENDENABLE, TRUE)},
      fcppt::variant::apply(sge::d3d9::state::core::blend::alpha_enabled_visitor(), _enabled));
}
