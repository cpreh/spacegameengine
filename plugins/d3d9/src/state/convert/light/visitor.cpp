...
sge::d3d9::state::convert::light::visitor::visitor(D3DLIGHT9 &_object) : object_(_object) {}

sge::d3d9::state::convert::light::visitor::result_type
sge::d3d9::state::convert::light::visitor::operator()(
    sge::renderer::state::ffp::lighting::light::directional const &_directional) const
{
  sge::d3d9::state::convert::light::directional(object_.get(), _directional);
}

sge::d3d9::state::convert::light::visitor::result_type
sge::d3d9::state::convert::light::visitor::operator()(
    sge::renderer::state::ffp::lighting::light::point const &_point) const
{
  sge::d3d9::state::convert::light::point(object_.get(), _point);
}

sge::d3d9::state::convert::light::visitor::result_type
sge::d3d9::state::convert::light::visitor::operator()(
    sge::renderer::state::ffp::lighting::light::spot const &_spot) const
{
  sge::d3d9::state::convert::light::spot(object_.get(), _spot);
}
