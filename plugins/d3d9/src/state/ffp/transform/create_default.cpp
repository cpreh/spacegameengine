...
sge::d3d9::state::ffp::transform::object_unique_ptr
sge::d3d9::state::ffp::transform::create_default(IDirect3DDevice9 &_device)
{
  return fcppt::make_unique_ptr<sge::d3d9::state::ffp::transform::object>(
      _device,
