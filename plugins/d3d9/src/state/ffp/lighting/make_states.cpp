...
sge::d3d9::state::render_vector sge::d3d9::state::ffp::lighting::make_states(
    sge::renderer::state::ffp::lighting::parameters const &_parameters)
{
  return fcppt::variant::apply(sge::d3d9::state::ffp::lighting::visitor(), _parameters.variant());
}
