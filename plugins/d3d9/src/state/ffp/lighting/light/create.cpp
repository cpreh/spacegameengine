...
{
  return fcppt::unique_ptr_to_base<sge::renderer::state::ffp::lighting::light::object>(
      fcppt::make_unique_ptr<sge::d3d9::state::ffp::lighting::light::object>(
          _device, sge::d3d9::state::ffp::lighting::light::make_states(_parameters)));
}
