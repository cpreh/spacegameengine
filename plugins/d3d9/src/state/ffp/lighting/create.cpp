...
sge::renderer::state::ffp::lighting::object_unique_ptr sge::d3d9::state::ffp::lighting::create(
    IDirect3DDevice9 &_device, sge::renderer::state::ffp::lighting::parameters const &_parameters)
{
  return fcppt::unique_ptr_to_base<sge::renderer::state::ffp::lighting::object>(
      fcppt::make_unique_ptr<sge::d3d9::state::ffp::lighting::object>(
          _device, sge::d3d9::state::ffp::lighting::make_states(_parameters)));
}
