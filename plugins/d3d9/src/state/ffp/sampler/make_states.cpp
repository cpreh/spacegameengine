...
sge::d3d9::state::ffp::sampler::state_vector sge::d3d9::state::ffp::sampler::make_states(
    sge::renderer::state::ffp::sampler::parameters const &_parameters)
{
  return fcppt::container::join(
      sge::d3d9::state::ffp::sampler::make_op(_parameters.alpha_op()),
      sge::d3d9::state::ffp::sampler::make_op(_parameters.color_op()));
}
