...
sge::d3d9::state::ffp::sampler::object_unique_ptr
sge::d3d9::state::ffp::sampler::create_default(IDirect3DDevice9 &_device)
{
  return fcppt::make_unique_ptr<sge::d3d9::state::ffp::sampler::object>(
      _device,
      sge::d3d9::state::ffp::sampler::make_states(sge::renderer::state::ffp::sampler::default_()));
}
