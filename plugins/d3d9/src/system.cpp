...
sge::d3d9::system::system(fcppt::log::object &_log)
    : sge::renderer::system(), log_{_log}, system_{sge::d3d9::create()}
{
}
...
sge::d3d9::system::create_core_renderer(sge::renderer::device::parameters const &_parameters)
{
...
sge::d3d9::system::create_ffp_renderer(sge::renderer::device::parameters const &_parameters)
{
  return fcppt::unique_ptr_to_base<sge::renderer::device::ffp>(
      fcppt::make_unique_ptr<sge::d3d9::device>(*system_, log_, _parameters));
}

awl::visual::object_unique_ptr
sge::d3d9::system::create_visual(sge::renderer::pixel_format::object const &_pixel_format)
{
  return fcppt::unique_ptr_to_base<awl::visual::object>(
      fcppt::make_unique_ptr<sge::d3d9::visual>(_pixel_format));
}
