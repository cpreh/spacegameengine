...
sge::d3d9::surface::color_onscreen_target(IDirect3DDevice9 &_device)
{
  return sge::d3d9::surface::color_create_function{
      [&_device]
      {
        return fcppt::optional::to_exception(
            sge::d3d9::devicefuncs::get_render_target(
                _device, sge::renderer::target::surface_index(0u)),
            [] { return sge::renderer::exception{FCPPT_TEXT("Unable to get render target.")}; });
      }};
}
