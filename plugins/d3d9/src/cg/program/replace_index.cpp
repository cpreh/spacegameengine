...
sge::cg::string sge::d3d9::cg::program::replace_index(
    sge::d3d9::vf::texture_coordinate_count const _texture_coordinates,
    sge::cg::program::extra_index const _index)
{
  return "TEXCOORD" + fcppt::output_to_string<sge::cg::string>(sge::d3d9::vf::convert::extra_index(
                          _texture_coordinates, sge::renderer::vf::dynamic::index(_index.get())));
}
