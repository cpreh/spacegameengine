...
sge::d3d9::texture::cube_types::unique_ptr sge::d3d9::texture::cube_types::create(
...
{
  return sge::d3d9::devicefuncs::create_cube_texture(_device, _parameters, _format, _pool, _usage);
}
...
void sge::d3d9::texture::cube_types::unlock(d3d_buffer &_buffer)
{
