...
sge::d3d9::texture::mipmap::usage_visitor::operator()(
    sge::renderer::texture::mipmap::all_levels_rep const &_all_levels) const
{
  return sge::d3d9::texture::mipmap::auto_generate_usage(_all_levels.auto_generate());
}

sge::d3d9::texture::mipmap::usage_visitor::result_type
sge::d3d9::texture::mipmap::usage_visitor::operator()(
    sge::renderer::texture::mipmap::levels_rep const &_levels) const
{
  return sge::d3d9::texture::mipmap::auto_generate_usage(_levels.auto_generate());
}

sge::d3d9::texture::mipmap::usage_visitor::result_type
sge::d3d9::texture::mipmap::usage_visitor::operator()(
    sge::renderer::texture::mipmap::off_rep const &) const
{
