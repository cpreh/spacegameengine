...
sge::d3d9::texture::volume_types::unique_ptr sge::d3d9::texture::volume_types::create(
...
{
  return sge::d3d9::devicefuncs::create_volume_texture(
      _device, _parameters, _format, _pool, _usage);
}
...
{
  return sge::d3d9::volumefuncs::lock_box(_buffer, _lock_dest, _flags);
}

void sge::d3d9::texture::volume_types::unlock(d3d_buffer &_buffer)
{
  sge::d3d9::volumefuncs::unlock_box(_buffer);
}
