...
sge::d3d9::vf::convert::index_visitor::index_visitor(
    ...
    : texture_coordinates_(_texture_coordinates)
{
}

sge::d3d9::vf::convert::index_visitor::result_type
sge::d3d9::vf::convert::index_visitor::operator()(sge::renderer::vf::dynamic::pos const &) const
{
  return static_cast<BYTE>(0);
}

sge::d3d9::vf::convert::index_visitor::result_type
sge::d3d9::vf::convert::index_visitor::operator()(sge::renderer::vf::dynamic::normal const &) const
{
  return static_cast<BYTE>(0);
}

sge::d3d9::vf::convert::index_visitor::result_type
sge::d3d9::vf::convert::index_visitor::operator()(sge::renderer::vf::dynamic::color const &) const
{
  return static_cast<BYTE>(0);
}
...
{
  return static_cast<BYTE>(_texpos.index().get());
}
    ...
    sge::renderer::vf::dynamic::extra const &_extra) const
{
  return static_cast<BYTE>(
      sge::d3d9::vf::convert::extra_index(texture_coordinates_, _extra.index()));
}
