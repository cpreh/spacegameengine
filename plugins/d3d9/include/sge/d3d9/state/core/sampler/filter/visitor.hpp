...
public:
  ...
  result_type
  operator()(sge::renderer::state::core::sampler::filter::anisotropic::parameters const &) const;

  result_type
  operator()(sge::renderer::state::core::sampler::filter::normal::parameters const &) const;
};
