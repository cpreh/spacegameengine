...
public:
  ...
  sge::d3d9::state::core::blend::object const &blend() const;

  sge::d3d9::state::core::depth_stencil::object const &depth_stencil() const;

  sge::d3d9::state::core::rasterizer::object const &rasterizer() const;

  sge::d3d9::state::core::sampler::object const &sampler() const;
