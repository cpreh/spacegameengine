...
#ifndef SGE_D3D9_STATE_FFP_CLIP_PLANE_CREATE_HPP_INCLUDED
#define SGE_D3D9_STATE_FFP_CLIP_PLANE_CREATE_HPP_INCLUDED
...
create(IDirect3DDevice9 &, sge::renderer::state::ffp::clip_plane::parameters const &);
