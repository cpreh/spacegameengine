...
public:
  ...
  result_type operator()(sge::renderer::state::ffp::sampler::unary_op const &) const;

  result_type operator()(sge::renderer::state::ffp::sampler::binary_op const &) const;

  result_type operator()(sge::renderer::state::ffp::sampler::ternary_op const &) const;
};
