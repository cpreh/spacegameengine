...
sge::d3d9::state::ffp::sampler::state const make_one_arg(Arg const _arg)
{
  return sge::d3d9::state::ffp::sampler::state(
      sge::d3d9::state::convert::sampler_arg_type<OpType, Arg>::get(),
      sge::d3d9::state::convert::sampler_arg(_arg.get()));
}
