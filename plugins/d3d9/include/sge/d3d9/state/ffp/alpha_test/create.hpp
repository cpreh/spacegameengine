...
#ifndef SGE_D3D9_STATE_FFP_ALPHA_TEST_CREATE_HPP_INCLUDED
#define SGE_D3D9_STATE_FFP_ALPHA_TEST_CREATE_HPP_INCLUDED
...
create(IDirect3DDevice9 &, sge::renderer::state::ffp::alpha_test::parameters const &);
