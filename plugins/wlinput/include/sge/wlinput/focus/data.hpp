...
struct data
{
	...
	fcppt::reference<
		sge::wlinput::focus::object
	> const focus_; // NOLINT(misc-non-private-member-variables-in-classes)

	sge::wlinput::xkb_context_ref const xkb_context_; // NOLINT(misc-non-private-member-variables-in-classes)

	awl::system::event::processor_ref const processor_; // NOLINT(misc-non-private-member-variables-in-classes)
	...
	sge::wlinput::focus::optional_keymap xkb_keymap_; // NOLINT(misc-non-private-member-variables-in-classes)

	sge::wlinput::focus::optional_state xkb_state_; // NOLINT(misc-non-private-member-variables-in-classes)

	sge::input::key::optional_code last_pressed_; // NOLINT(misc-non-private-member-variables-in-classes)
