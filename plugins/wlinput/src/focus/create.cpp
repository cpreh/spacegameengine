...
sge::wlinput::focus::create_function sge::wlinput::focus::create(
...
{
  return sge::wlinput::focus::create_function{
      [_log, _sge_window, _context, _window, _events](awl::backends::wayland::seat_ref const _seat)
      {
        return fcppt::make_unique_ptr<sge::wlinput::focus::object>(
            _log, _sge_window, _context, _window, _events, _seat);
      }};
}
