...
#ifndef SGE_SDLINPUT_TRANSLATE_MOUSE_MOTION_EVENT_HPP_INCLUDED
#define SGE_SDLINPUT_TRANSLATE_MOUSE_MOTION_EVENT_HPP_INCLUDED
...
awl::event::container mouse_motion_event(
