...
awl::event::optional_base_unique_ptr sge::sdlinput::keyboard::translate_event(
    sge::input::keyboard::shared_ptr const &_keyboard, SDL_KeyboardEvent const &_event)
{
        ...
        return fcppt::unique_ptr_to_base<awl::event::base>(
            fcppt::make_unique_ptr<sge::input::keyboard::event::key>(
                ...
                sge::input::keyboard::key{
                    sge::sdlinput::translate::key_code(_event.keysym.sym),
                    sge::input::keyboard::key_id{_event.keysym.scancode}},
