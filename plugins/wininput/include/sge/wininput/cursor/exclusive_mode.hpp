...
{
  FCPPT_NONCOPYABLE(exclusive_mode);

public:
  exclusive_mode(sge::window::object_ref, awl::backends::windows::window::object &);
...
private:
  ...
  void on_temp_unacquire(awl::backends::windows::message_type);

  void on_temp_acquire(awl::backends::windows::message_type);

  typedef fcppt::optional::object<awl::backends::windows::message_type> optional_event_type;
