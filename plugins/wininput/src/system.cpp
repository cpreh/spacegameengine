...
sge::wininput::system::create_processor(sge::window::object_ref const _window)
{
  return fcppt::unique_ptr_to_base<sge::input::processor>(
      fcppt::make_unique_ptr<sge::wininput::processor>(fcppt::make_ref(log_), _window));
}

sge::input::capabilities_field sge::wininput::system::capabilities() const
{
