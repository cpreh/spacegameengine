...
sge::wininput::processor::processor(
    ...
    : log_{_log},
      window_{_window},
      cursor_{fcppt::make_shared_ptr<sge::wininput::cursor::object>(
          window_,
          fcppt::optional::to_exception(
              ...
              .get())},
      focus_{fcppt::make_shared_ptr<sge::wininput::focus::object>(window_)},
...
sge::wininput::processor::~processor() = default;

sge::window::object &sge::wininput::processor::window() const { return window_.get(); }

sge::input::cursor::container sge::wininput::processor::cursors() const
{
  return sge::input::cursor::container{sge::input::cursor::shared_ptr{cursor_}};
}

sge::input::focus::container sge::wininput::processor::foci() const
{
  return sge::input::focus::container{sge::input::focus::shared_ptr{focus_}};
}

sge::input::joypad::container sge::wininput::processor::joypads() const
{
  return sge::input::joypad::container{};
}

sge::input::keyboard::container sge::wininput::processor::keyboards() const
{
  return sge::input::keyboard::container{};
}

sge::input::mouse::container sge::wininput::processor::mice() const
{
  return sge::input::mouse::container{};
}

awl::event::container sge::wininput::processor::on_event(awl::window::event::base const &_event)
{
...
void sge::wininput::processor::on_window_event(
    awl::backends::windows::window::event::generic const &_event)
{
  if (_event.type().get() == WM_KILLFOCUS)
    this->on_focus_out();
}

void sge::wininput::processor::on_focus_out()
{
  FCPPT_LOG_DEBUG(log_.get(), fcppt::log::out << FCPPT_TEXT("focus out"))
