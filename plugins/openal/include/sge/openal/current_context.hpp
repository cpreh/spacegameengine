...
{
  FCPPT_NONMOVABLE(current_context);

public:
  current_context(fcppt::log::object_reference, fcppt::reference<sge::openal::context>);
...
private:
  ...
  fcppt::reference<sge::openal::context> const context_;
};
