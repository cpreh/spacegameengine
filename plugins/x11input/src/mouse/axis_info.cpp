...
sge::input::mouse::axis_info sge::x11input::mouse::axis_info(
    XIValuatorClassInfo const &_info, awl::backends::x11::display &_display)
{
  fcppt::optional_string const name(
      sge::x11input::device::info::string_from_atom(_display, _info.label));

  return sge::input::mouse::axis_info(
      sge::x11input::mouse::axis_code(name),
      // TODO(philipp)
