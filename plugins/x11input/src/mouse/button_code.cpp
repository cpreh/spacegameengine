...
sge::x11input::mouse::button_code(fcppt::optional_string const &_info)
{
  return fcppt::optional::maybe(
      ...
      {
        if (_name == FCPPT_TEXT("Button Left"))
        {
          return sge::input::mouse::button_code::left;
        }

        if (_name == FCPPT_TEXT("Button Right"))
        {
          return sge::input::mouse::button_code::right;
        }

        if (_name == FCPPT_TEXT("Button Middle"))
        {
