...
sge::x11input::system::~system() = default;
...
sge::x11input::system::create_processor(sge::window::object_ref const _window)
{
  ...
  {
    throw sge::input::exception{FCPPT_TEXT("The X server doesn't support XI2.1!")};
  }

  return fcppt::unique_ptr_to_base<sge::input::processor>(
      fcppt::make_unique_ptr<sge::x11input::processor>(fcppt::make_ref(log_), _window, opcode));
}

sge::input::capabilities_field sge::x11input::system::capabilities() const
{
