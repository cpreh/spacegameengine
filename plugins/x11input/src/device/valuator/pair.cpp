...
sge::x11input::device::valuator::index sge::x11input::device::valuator::pair::index() const
{
  return index_;
}

sge::x11input::device::valuator::value sge::x11input::device::valuator::pair::value() const
{
  return value_;
}
