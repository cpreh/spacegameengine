...
sge::x11input::focus::object::object(
    ...
    : sge::input::focus::object{},
      fcppt::enable_shared_from_this<sge::x11input::focus::object>{},
      sge_window_{_sge_window},
      log_{_log},
      window_{fcppt::reference_to_const(
          fcppt::reference_to_base<awl::backends::x11::window::base>(_window))},
      xim_context_{fcppt::optional::map(
          _xim_method,
          [&_window](fcppt::reference<sge::x11input::xim::method const> const _method) {
            return fcppt::make_unique_ptr<sge::x11input::xim::context>(
                _method.get().get(), _window);
          })},
      mask_connection_{fcppt::optional::map(
          xim_context_,
          [&_window](xim_context_unique_ptr const &_context) {
            return _window.get().add_event_mask(sge::x11input::xim::get_filter_events(*_context));
          })},
          ...
          }})}
{
  sge::x11input::event::select<fcppt::mpl::list::object<
      ...
      sge::x11input::event::type_c<XI_FocusOut>>>(_window_demuxer.get(), _id);
}

sge::x11input::focus::object::~object() = default;

sge::window::object &sge::x11input::focus::object::window() const { return sge_window_.get(); }

awl::event::container sge::x11input::focus::object::on_event(XIDeviceEvent const &_event)
{
  switch (_event.evtype)
  {
  case XI_KeyPress:
    return this->on_key_press(_event);
  case XI_KeyRelease:
...
awl::event::container sge::x11input::focus::object::on_key_press(XIDeviceEvent const &_event)
{
  sge::x11input::key::repeated const repeated{sge::x11input::key::is_repeated(_event)};

  return fcppt::optional::maybe(
      xim_context_,
      [this, repeated, &_event]
      {
        return fcppt::container::make<awl::event::container>(this->process_key_down(
            repeated,
            sge::x11input::key::event_to_sge_code(window_.get().display().get(), _event)));
      },
      [this, repeated, &_event](xim_context_unique_ptr const &_context)
      {
        sge::x11input::focus::looked_up_string const lookup(
            sge::x11input::focus::lookup_string(log_.get(), *_context, _event));

        return fcppt::container::make<awl::event::container>(
            this->process_key_down(repeated, lookup.key_code()),
            fcppt::unique_ptr_to_base<awl::event::base>(
                fcppt::make_unique_ptr<sge::input::focus::event::text>(
                    ...
                    fcppt::algorithm::map<sge::input::focus::string>(
                        lookup.char_codes(), fcppt::identity{}))));
      });
}

awl::event::base_unique_ptr
sge::x11input::focus::object::on_key_release(XIDeviceEvent const &_event)
{
  return fcppt::unique_ptr_to_base<awl::event::base>(
      fcppt::make_unique_ptr<sge::input::focus::event::key>(
          ...
          sge::input::focus::key{
              sge::x11input::key::event_to_sge_code(window_.get().display().get(), _event)},
          sge::input::key::pressed{false}));
}

awl::event::base_unique_ptr sge::x11input::focus::object::on_focus_in()
{
  fcppt::optional::maybe_void(
      xim_context_, [](xim_context_unique_ptr const &_context) { ::XSetICFocus(_context->get()); });
...
awl::event::base_unique_ptr sge::x11input::focus::object::on_focus_out()
{
  fcppt::optional::maybe_void(
      xim_context_,
      [](xim_context_unique_ptr const &_context) { ::XUnsetICFocus(_context->get()); });
...
awl::event::base_unique_ptr sge::x11input::focus::object::process_key_down(
    sge::x11input::key::repeated const _repeated, sge::input::key::code const _key_code)
{
  sge::input::focus::key const key(_key_code);

  return _repeated.get()
             ? fcppt::unique_ptr_to_base<awl::event::base>(
